...
@define('MLORPHAN_MTASK_MAIN_PATTERN_ID_ERROR', 'Please fix: Entry: %d  [<em>%s</em> textarea field] for a <em>probably</em> <b>wrong</b> used s9ymdb: ID (%d) for an image src "<em>%s</em>" path first and then run this script again. To do this, check and search the collapsible "view array" box down below by "<em>%s</em>" for the correct image ID [id].');
