...
@define('PLUGIN_EVENT_SPARTACUS_REPOSITORY_ERROR', '(repozytorium zwróci³o kod b³êdu %s.)');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHCHECK', 'Nie mogê pobraæ danych z repozytorium SPARTACUSa. Sprawdzam dostêpno¶æ repozytorium.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHERROR', 'Strona z informacj± o dostêpno¶ci repozytoriów dla SPARTACUSa zwróci³a b³±d (kod HTTP %s). To oznacza, ¿e strona aktualnie nie funkcjonuje. Proszê spróbowaæ ponownie pó¼niej.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHLINK', '<a target="_blank" rel="noopener" href="%s">Kliknij tutaj</a> by zobaczyæ stronê z informacj± o dostêpno¶ci repozytoriów dla SPARTACUSa i sprawd¼, czy strona odpowiada.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHBLOCKED', 'SPARTACUS próbowa³ po³±czyæ siê z Google i nie powiod³a siê ta operacja (b³±d %d: %s).<br>Twój serwer blokuje po³±czenia wychodz±ce. Your server is blocking outgoing connections. SPARTACUS nie bêdzie funkcjonowa³ prawid³owo poniewa¿ nie mo¿e skontaktowaæ siê z repozytorium. <b>Proszê, skontaktuj siê z providerem i popro¶ o zezwolenie na po³±czenia wychodz±ce z serwera.</b> Wtyczki mog± byæ oczywi¶cie instalowane bezpo¶rednio z katalogów na serwerze. Po prostu pobierz wtyczkê z <a href="http://spartacus.s9y.org">repozytorium origin SPARTACUSa</a>, rozpakuj, wgraj rozpakowany katalog do katalogu wtyczek (plugins). For Styx link to the <a href="https://ophian.github.io/plugins/">Styx Spartacus website</a>.');
