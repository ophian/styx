...
@define('PLUGIN_EVENT_SPARTACUS_HEALTHLINK', '<a target="_blank" href="%s">Kliknij tutaj</a> by zobaczyæ stronê z informacj± o dostêpno¶ci repozytoriów dla SPARTACUSa i sprawd¼, czy strona odpowiada.');
