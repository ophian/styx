...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'URL %s nie mógł być otwarty. Być może serwer github lub mirror aktualnie nie działa - w takim przypadku przepraszamy i prosimy spróbowac ponownie później. Try to reload (F5) the page first.');
...
@define('PLUGIN_EVENT_SPARTACUS_REPOSITORY_ERROR', '(repozytorium zwróciło kod błędu %s.)');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHCHECK', 'Nie mogę pobrać danych z repozytorium SPARTACUSa. Sprawdzam dostępność repozytorium.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHERROR', 'Strona z informacją o dostępności repozytoriów dla SPARTACUSa zwróciła błąd (kod HTTP %s). To oznacza, że strona aktualnie nie funkcjonuje. Proszę spróbować ponownie później.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHLINK', '<a target="_blank" rel="noopener" href="%s">Kliknij tutaj</a> by zobaczyć stronę z informacją o dostępności repozytoriów dla SPARTACUSa i sprawdź, czy strona odpowiada.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHBLOCKED', 'SPARTACUS próbował połączyć się z Google i nie powiodła się ta operacja (błąd %d: %s).<br>Twój serwer blokuje połączenia wychodzące. Your server is blocking outgoing connections. SPARTACUS nie będzie funkcjonował prawidłowo ponieważ nie może skontaktować się z repozytorium. <b>Proszę, skontaktuj się z providerem i poproś o zezwolenie na połączenia wychodzące z serwera.</b> Wtyczki mogą być oczywiście instalowane bezpośrednio z katalogów na serwerze. Po prostu pobierz wtyczkę z <a href="http://spartacus.s9y.org">repozytorium origin SPARTACUSa</a>, rozpakuj, wgraj rozpakowany katalog do katalogu wtyczek (plugins). For Styx link to the <a href="https://ophian.github.io/plugins/">Styx Spartacus website</a>.');
