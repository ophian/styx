...
@define('PLUGIN_EVENT_SPARTACUS_CUSTOMMIRROR_DESC_ADD', 'ACHTUNG: Die Warnung gilt daher nur begrenzt und NICHT für Styx. Die hier per default voreingestellte URL ist auf das Styx "additional_plugins" Verzeichnis limitiert. Zusätzliche THEMES werden weiterhin von den oben eingestellten Spiegelservern gezogen. Dies kann sich in Zukunft ändern. Es ist keineswegs empfehlenswert diesen eigenständigen Styx Plugin-Mirror NICHT zu benutzen, da bereits zu viele Änderungen und Fixes eingeflossen sind und das Styx Plugin Repository auf Styx abgestimmt und dem Serendipity Original schon weit voraus ist! Möchten Sie grundsätzlich nur die obigen Spiegelserver nutzen, müssen Sie vor jedem Konfigurationssubmit die hier eingestellte URL per Hand löschen, bzw. einmalig "none" hineinschreiben (ohne "").');
