...
@define('PLUGIN_EVENT_SPARTACUS_CUSTOMMIRROR_DESC_ADD', 'ACHTUNG: Styx zieht seine Daten direkt von GitHub, wie oben eingestellt. Die voreingestellte URL ist auf das Serendipity Styx "additional_plugins" Verzeichnis limitiert. Zusätzliche THEMES werden weiterhin vom s9y GitHub Repository Server gezogen. Dies kann sich in Zukunft ändern. Möchten Sie grundsätzlich nur die obigen Spiegelserver nutzen, müssen Sie vor jedem Konfigurationssubmit die eigenen Spiegelserver per Hand löschen, bzw. einmalig "none" hineinschreiben (ohne "").');
