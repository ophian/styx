...
@define('PLUGIN_EVENT_SPARTACUS_CUSTOMMIRROR_DESC', 'Diese Option ist nur für Experten gedacht. Falls keiner der voreingestellten Mirror-Server aufgrund von Downtime oder Problemen verfügbar ist, kann hier ein eigener Server-Name wie http://mirror.org/serendipity/ eingetragen werden. Dort müssten die XML-Dateien für Spartacus im Verzeichnis liegen, und Unterverzeichnisse wie additional_plugins und additional_themes existieren. Geben Sie hier nur Mirrors ein, denen Sie vertrauen, und auf denen eine Kopie unseres CVS-Repositories gespeichert ist. Mehrere Mirrors können mit "|" getrennt eingegeben werden.');
@define('PLUGIN_EVENT_SPARTACUS_CUSTOMMIRROR_DESC_ADD', ' ACHTUNG: Die Warnung gilt daher nur noch begrenzt und NICHT mehr für Styx. Die hier bereits eingetragene URL ist auf das Styx "additional_plugins" Verzeichnis limitiert. Zusätzliche THEMES werden weiterhin von den oben eingestellten Spiegelservern gezogen. Dies kann sich in Zukunft ändern. Es ist NICHT empfehlenswert diesen eigenständigen Styx Mirror NICHT zu nutzen, da zu viele Änderungen und Fixes bereits eingeflossen sind und das Styx Plugin repository dem Original schon weit voraus ist.');
