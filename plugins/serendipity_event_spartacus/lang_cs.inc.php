...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'URL %s nelze otevøít. Server github nebo mirror možná nebìží - omlouváme se, zkuste to pozdìji. Try to reload (F5) the page first.');
