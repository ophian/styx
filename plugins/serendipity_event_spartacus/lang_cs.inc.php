...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'URL %s nelze otevøít. Server github nebo mirror možná nebìží - omlouváme se, zkuste to pozdìji. Try to reload (like Ctrl-F5) the page first.');
...
@define('PLUGIN_EVENT_SPARTACUS_REPOSITORY_ERROR', '(On-line úložištì vrátilo chybu %s.)');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHCHECK', 'Nebylo možno získat data z on-line úložištì modulu Spartacus. Zkouška dostupnosti úložištì na adrese %s.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHERROR', 'Diagnstická stránka modulu Spartacus vrátilo chybu (HTTP kód %s). To mùže znamenat, že je dignostická stránka mimo provoz. Zkuste to prosím pozdìji.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHLINK', '<a target="_blank" href="%s">Kliknìte zde pro zobrazení diagnstické stránky modulu Spartacus</a> a zjistìte, zda odpovídá.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHBLOCKED', 'SPARTACUS se pokusil pøipojit ke Googlu, ale neúspìšnì (chyba è.%d: %s).<br/>Váš server blokuje odchozí spojení. SPARTACUS nebude fungovat, protože se nemùže pøipojit do svého online úložištì. <b>Kontaktujte prosím svého poskytovatele webhostingu a požádejte ho o povolení odchozích pøipojení k jiným webovým stránkám.</b> Zásuvné moduly lze instalovat z lokálních adresáøù. Jednoduše stáhnìte nejnovìjší verzi pluginu z <a href="http://spartacus.s9y.org">SPARTACUS origin web úložištì</a>, rozbalte ho a napøíklad pomocí FTP nahrajte do adresáøe /plugins/ ve Vaší instalaci Serendipity. For Styx link to the <a href="https://ophian.github.io/plugins/">Styx Spartacus website</a>.');
@define('PLUGIN_EVENT_SPARTACUS_HEALTHDOWN', 'Modulu SPARTACUS se podaøilo spojit s Googlem, ale nemùže se spojit s on-line úložištìm modulu SPARTACUS. Je možné, že Váš server blokuje nìkterá odchozí spojení, nebo je on-line úložištì mimo provoz. Spojte se se svým poskytovatelem webového serveru, abyste se ujistili, že nemáte blokována odchozí spojení. <b>SPARTACUS nebude fungovat, protože nemùže kontaktovat on-line úložištì.</b>');
