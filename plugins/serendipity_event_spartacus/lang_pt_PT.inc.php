...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'Impossível aceder ao endereço %s. Pode ser que o servidor do github ou de mirror esteja temporariamente inacessível. Tente por favor mais tarde. Try to reload (F5) the page first.');
