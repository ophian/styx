...
@define('PLUGIN_EVENT_SPARTACUS_HEALTHLINK', '<a target="_blank" href="%s">Klikněte zde pro zobrazení diagnstické stránky modulu Spartacus</a> a zjistěte, zda odpovídá.');
