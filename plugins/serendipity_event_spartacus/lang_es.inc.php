...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'El URL %s no pudo ser abierto. Quizás github o el servidor en mirror están desconectados - lo lamentamos, intenta de nuevo más tarde. Try to reload (F5) the page first.');
