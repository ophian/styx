...
@define('PLUGIN_EVENT_SPARTACUS_CSPRNG', ' (Random string example: "%s%s". Please take this "obfuscated" string to use it remotely with the serendipity_event_plugup Dashboard-Plugin Check-Update notification.)');
