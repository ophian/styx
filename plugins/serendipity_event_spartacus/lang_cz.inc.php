...
@define('PLUGIN_EVENT_SPARTACUS_FETCHERROR', 'URL %s nelze otevøít. Server github nebo mirror mo¾ná nebì¾í - omlouváme se, zkuste to pozdìji. Try to reload (like Ctrl-F5) the page first.');
