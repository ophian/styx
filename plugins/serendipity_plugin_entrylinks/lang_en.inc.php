...
@define('PLUGIN_ENTRYLINKS_BLAHBLAH', 'Shows all links referenced in an article');
...
@define('PLUGIN_ENTRYLINKS_WORDWRAP_BLAHBLAH', 'How many words until a word wrap will occur? (Default: 30)');
