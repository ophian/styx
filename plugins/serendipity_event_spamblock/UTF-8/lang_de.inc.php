...
@define('PLUGIN_EVENT_SPAMBLOCK_CAPTCHAS_DESC', 'Erfordert die Eingabe eines zufälligen Buchstabenfolge vom Benutzer, damit ein Kommentar angenommen wird. Diese Eingabe kann von Spambots nicht getätigt werden und verhindert so automatische Kommentare. Jedoch können behinderte oder blinde Personen mit der Darstellung solcher Eingabegrafiken Probleme haben. Um Captchas ganz zu vermeiden, können Sie das erweiternde Serendipity Spamblog Bee Plugin ausprobieren.');
...
@define('PLUGIN_EVENT_SPAMBLOCK_FORCEMODERATION_DESC', 'Eingehende Artikelkommentare können, abhängig vom Alter des Artikels, automatisch auf "Moderation" gestellt werden. Tragen Sie hier das Minimalalter eines Artikels in Tagen ein, ab dem jeder Kommentar zunächst automatisch in die Moderations-Warteschlange gestellt wird. 0 bedeutet, dass diese Option nicht verwendet wird. (Diese Option wird folgend auch als "auto-moderiert" bezeichnet.)');
...
@define('PLUGIN_EVENT_SPAMBLOCK_FORCEMODERATIONT_DESC', 'Alle eingehenden Trackbacks/Pingbacks zu einem Artikel können, abhängig vom Alter des Artikels, automatisch auf "Moderation" gestellt werden. Tragen Sie hier das Minimalalter eines Artikels in Tagen ein, ab dem jedes Trackback/Pingback zunächst automatisch in die Moderations-Warteschlange gestellt wird. 0 bedeutet, dass diese Option nicht verwendet wird.');
