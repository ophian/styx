...
@define('PLUGIN_EVENT_SPAMBLOCK_CAPTCHAS_DESC', 'Verplicht bezoekers een reeks letters te herhalen die uit een plaatje komen. Handig om geautomatiseerde posts tegen te gaan. Denk eraan dat bezoekers met verminderd zicht dit soms moeilijk kunnen uitvoeren. To avoid having to use visible Captchas at all, try out the extending Spamblock Bee plugin.');
