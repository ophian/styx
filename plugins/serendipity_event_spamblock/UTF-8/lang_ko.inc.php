...
@define('PLUGIN_EVENT_SPAMBLOCK_CAPTCHAS_DESC', '사용자가 특별 제작된 그림에 나타난 무작위 문자열을 입력하도록 강제합니다. 블로그에 자동화된 덧글이 달리는 것을 방지해줍니다. 시력이 떨어지는 사람은 captcha를 읽는데 곤란해 할 수 있음을 유의하십시오. To avoid having to use visible Captchas at all, try out the extending Spamblock Bee plugin.');
