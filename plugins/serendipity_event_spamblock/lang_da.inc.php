...
@define('PLUGIN_EVENT_SPAMBLOCK_CAPTCHAS_DESC', 'Kræver at brugeren indtaster en tilfældig tekst som vises i et specielt tegnet stykke grafik (CAPTHA). Dette kan forhindre robotter i at gemme kommentarer i din blog. Bemærk at svagtseende kan have problemer med at læse teksten i grafikken. To avoid having to use visible Captchas at all, try out the extending Spamblock Bee plugin.');
