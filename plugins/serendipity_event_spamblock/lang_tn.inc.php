...
@define('PLUGIN_EVENT_SPAMBLOCK_CAPTCHAS_DESC', '訪客要留言時必須輸入圖片裡出現的文字。可允許自動廣告程式輸入迴響。記得有些訪客可能無法解讀圖片裡的文字。 To avoid having to use visible Captchas at all, try out the extending Spamblock Bee plugin.');
