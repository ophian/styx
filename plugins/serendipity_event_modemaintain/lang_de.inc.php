...
@define('PLUGIN_MODEMAINTAIN_DASHBOARD_EXWARNING_DESC', "ACHTUNG:<br>\nEs <em>kann</em> unter Umständen eine (Browser-Session basierende) Situation geben, bei dem obiger 503-Submit-Knopf nach dem Absenden und Seitenreload seine Farbe (grün/rot) nicht unmittelbar ändert, um anzuzeigen, in welchem Modus sich die Wartung gerade wirklich befindet. In diesem Fall können Sie den Knopf nach ca 1 Sekunde entweder erneut drücken, ODER besser auf derselben Browserseite irgendwohin ins Backend gehen und zurückkehren. Erst dann sehen Sie den augenblicklichen Status.");
