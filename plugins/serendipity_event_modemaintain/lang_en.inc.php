...
@define('PLUGIN_MODEMAINTAIN_OPENSSL_TIME_RESTRICTION', 'The Styx required OPENSSL_VERSION_NUMBER does not match! Autologin is restricted to work within 24 hours only from set. Do NOT hide your blog by this 503-Maintenance-Mode longer than "<strong>%s</strong>" hours from NOW on!');
