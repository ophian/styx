...
@define('PLUGIN_MODEMAINTAIN_DASHBOARD_EXWARNING_DESC', "WARNING:<br>\nCurrently there <em>may</em> be a page (cache) loading behavior, not switching the mode button (green/red) here immediately after page reload. You then need to click somewhere else in the backend via sidebar and return, to see the button change (which has to get: green to red, or vice versa).");
