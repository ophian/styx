...
@define('PLUGIN_EVENT_PLUGUP_SPARTACUS_URL_DESC', 'Please enable the remote plugin version information in SPARTACUS options and add here the "<em>secret</em>" key to the remote plugin version information! This is only readable for admin users in the Dashboard. Move the Plugup-plugin beneath the Spartacus-plugin in list.');
