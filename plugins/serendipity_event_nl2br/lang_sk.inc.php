...
@define('PLUGIN_EVENT_NL2BR_ISOLATE_TAGS_DESC', 'A list of HTML-tags where no breaks shall be converted. Návrhy: "pre,geshi,textarea". Názvy tagov oddeµova» èiarkou. Tip: Zadané tagy sú vyhodnocované ako regulárny výraz.');
