...
@define('PLUGIN_EVENT_WRAPPER_DESC', 'Muestra información obtenida a través de cierta extensión de evento, cuando imprime algo a través del método generate_content(&$title).');
