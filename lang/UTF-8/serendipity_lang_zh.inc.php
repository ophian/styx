...
#          http://www.cexten.com
# TO ANY FUTURE TRANSLATOR: Due to conversion issues, please compare and check all these constant vars against the <en> file again. Thanks.
...
@define('ERROR_UNKNOWN_NOUPLOAD', '鍙戠敓閿欒, 鏂囦欢娌℃湁涓婁紶锛屽彲鑳藉洜涓轰綘鐨勬枃浠惰秴杩囬檺鍒剁殑澶у皬锛, 璇疯闂綘鐨勪富鏈哄晢鎴栦慨鏀逛綘鐨 php.ini 鏂囦欢灞炴。');
@define('GO', '缁х画');
@define('NEWSIZE', '澶у皬: ');
...
@define('PLUGIN_GROUP_BACKEND_MAINTAIN', '鍚庣 Maintenance');
@define('PLUGIN_GROUP_BACKEND_DASHBOARD', '鍚庣 Dashboard');
...
@define('STYLE_OPTIONS_NONE', '杩欎釜涓婚娌℃湁鐗瑰埆鐨勯€夐」銆傚鏋滆鍦ㄤ綘鐨勪富棰橀噷鍔犱笂閫夐」锛岃娴忚 www.s9y.org 鍐呯殑 Technical Documentation, 锛岀劧鍚 "Configuration of Theme options"銆');
