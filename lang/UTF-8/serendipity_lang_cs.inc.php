...
@define('IMAGESYNC_WARNING', 'POZOR:<br>Tato akce m??e trvat d?le, pokud m?te mnoho obr?zk? bez n?hled?.');
...
@define('PERMISSION_PERSONALCONFIGURATIONRIGHTPUBLISH', 'personalConfigurationRightPublish: Zm?nit pr?vo na publikov?n? p??sp?vk?');
@define('PERMISSION_SITECONFIGURATION', 'siteConfiguration: Konfigurace  p??stupu');
@define('PERMISSION_SITEAUTOUPGRADES', 'siteAutoUpgrades: Access system autoupgrades');
@define('PERMISSION_BLOGCONFIGURATION', 'blogConfiguration: Konfigurace p??stupu k  blogu');
@define('PERMISSION_ADMINENTRIES', 'adminEntries: Administrace p??sp?vk?');
@define('PERMISSION_ADMINENTRIESMAINTAINOTHERS', 'adminEntriesMaintainOthers: Administrace p??sp?vk? ostatn?ch u?ivatel?');
@define('PERMISSION_ADMINIMPORT', 'adminImport: Import p??sp?vk?');
@define('PERMISSION_ADMINCATEGORIES', 'adminCategories: Administrace kategori?');
@define('PERMISSION_ADMINCATEGORIESMAINTAINOTHERS', 'adminCategoriesMaintainOthers: Administrace kategori? ostatn?ch u?ivatel?');
@define('PERMISSION_ADMINCATEGORIESDELETE', 'adminCategoriesDelete: Smazat kategorie');
@define('PERMISSION_ADMINUSERS', 'adminUsers: Administrace u?ivatel?');
@define('PERMISSION_ADMINUSERSDELETE', 'adminUsersDelete: Smazat u?ivatele');
@define('PERMISSION_ADMINUSERSEDITUSERLEVEL', 'adminUsersEditUserlevel: Zm?na ?rovn? u?ivatele');
@define('PERMISSION_ADMINUSERSMAINTAINSAME', 'adminUsersMaintainSame: Administrace u?ivatel? ve stejn? skupin?');
@define('PERMISSION_ADMINUSERSMAINTAINOTHERS', 'adminUsersMaintainOthers: Administrace u?ivatel? v jin?ch skupin?ch');
@define('PERMISSION_ADMINUSERSCREATENEW', 'adminUsersCreateNew: Zakl?dat nov? u?ivatele');
@define('PERMISSION_ADMINUSERSGROUPS', 'adminUsersGroups: Administrace skupin u?ivatel?');
@define('PERMISSION_ADMINPLUGINS', 'adminPlugins: Administrace plugin?');
@define('PERMISSION_ADMINPLUGINSMAINTAINOTHERS', 'adminPluginsMaintainOthers: Administrace plugin? ostatn?ch u?ivatel?');
@define('PERMISSION_ADMINIMAGES', 'adminImages: Administrace soubor?  media');
@define('PERMISSION_ADMINIMAGESDIRECTORIES', 'adminImagesDirectories: Administrace adres??? pro media');
@define('PERMISSION_ADMINIMAGESADD', 'adminImagesAdd: P?id?v?n? nov?ch soubor? medi?');
@define('PERMISSION_ADMINIMAGESDELETE', 'adminImagesDelete: Maz?n? soubor? medi?');
...
@define('STYLE_OPTIONS_NONE', 'Toto t?ma/styl nem? specifick? volby. Pokud chcete v?d?t, jak m??ete pro svoje ?ablony nastavit specifick? volby, ?t?te Technical Documentation na "https://ophian.github.io/hc/en/templating.html#docs-theme-options"  "Configuration of Theme options".');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Je-li povoleno, m??e serendipity_admin_image_selector.php file vracet obr?zky v jak?koli po?adovan? velikosti p?es prom?nnou  GET. V?sledky jsou ke?ov?ny, a tak se m??e vytvo?it velk? soubor, jestli?e to intenzivn? pou??v?te.');
...
@define('NAVLINK_AMOUNT', 'Zadejte po?et odkaz? naviga?n? li?ty (and save this form)');
