...
@define('INSTALL_CHARSET_DESC', 'Zde m??ete volit mezi UTF-8 nebo n?rodn? (ISO, EUC, ...) znakovou sadou. N?kter? jazyky maj? jen p?eklady UTF-8, tak?e nastaven? znakov? sady na n?rodn? nem? ??dn? ??inek. UTF-8 se doporu?uje pro nov? instalace. Nem??te toto nastaven?, jestli?e jste ji?  napsali p??sp?vky se speci?ln?mi (n?rodn?mi) znaky - mohlo by zp?sobit poru?en? textu. P?e?t?te si o tomto probl?mu v?ce na  http://www.s9y.org/index.php?node=46 .');
