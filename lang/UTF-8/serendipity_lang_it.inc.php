...
@define('IMAGESYNC_WARNING', 'ATTENZIONE:<br>Potrebbe essere necessario molto tempo se molte immagini non hanno le miniature. Particularly with migrations of old blogs, further preliminary considerations and knowledge are necessary! Read about it on <a href="https://ophian.github.io/hc/en/media-migration-tasks.html" target="_new">this help page</a>, carefully.');
...
@define('SUBSCRIBE_TO_BLOG', 'Diffondi Questo Blog');
...
@define('DO_MARKUP_DESCRIPTION', 'Applica trasformazioni di markup (plugin) al testo (faccine, bbcode, scorciatoie s9y, markdown, ecc.). Se disattivata, il contenuto viene reso 1:1 e qualsiasi formattazione HTML viene conservata. Se questa opzione è attivata, altri plugin possono modificare il contenuto della pepita.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Hai ignorato la procedura di upgrade di  Serendipity, per favore controlla che il tuo database sia correttamente installato e che le funzioni periodiche vengano lanciate. Dopo aver terminato il lavoro ragionato per la sospensione, questo può essere fatto automaticamente semplicemente reimpostando la versione nel file serendipity_config_local.inc ed eseguendo nuovamente questa pagina di aggiornamento tramite la pagina di backend.');
...
@define('INSTALL_DBPREFIX_DESC', 'Prefisso per i nomi delle tabelle, per esempio styx_');
...
@define('INSTALL_WYSIWYG_DESC', 'Vuoi usare l\'editor WYSIWYG?<br>For more comfort and quicker updates it is recommended to install the extended CKEditor Plus event Plugin!');
...
@define('POWERED_BY_SHOW_TEXT', 'Mostra "%s" come testo');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Mostra "Serendipity Styx Weblog" come testo');
@define('POWERED_BY_SHOW_IMAGE', 'Mostra "%s" con un logo');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Mostra il logo di %s');
...
@define('PGSQL_REQUIRED', 'Occorre l\'estensione PostgreSQL per effettuare questa azione.');
@define('COULDNT_CONNECT', 'Impossobile connettersi al database MySQL: %s.');
@define('PGSQL_COULDNT_CONNECT', 'Impossobile connettersi al database PostgreSQL: %s.');
...
@define('WELCOME_TO_INSTALLATION', 'Benvenuti nell\'Installazione di Serendipity Styx');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx è stato installato con successo');
@define('VISIT_BLOG_HERE', 'Visita il tuo nuovo blog qui');
@define('THANK_YOU_FOR_CHOOSING', 'Grazie per aver scelto Serendipity Styx');
...
@define('USERCONF_USERLEVEL_DESC', 'Questo livello è utilizzato per determinare che tipo di accesso al blog abbia questo utente. I privilegi degli utenti sono gestiti dalle appartenenze di gruppo!');
...
@define('HOTLINK_DONE', 'File "%s" hot-linkato.<br>Internal name: \'%s\'. Fatto.');
