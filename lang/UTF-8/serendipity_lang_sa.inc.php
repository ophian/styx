...
@define('DELETE_DIRECTORY_DESC', 'أنت على وشك حذف دليل<sup>(¹)</sup> قد يحتوي على ملفات وسائط وعناصر مستخدمة بالفعل في إدخالاتك. تأكد!<sup>[¹]</sup> بما في ذلك القرص الفرعي المخفي الذي يحتوي على ملفات التباين (WebP/AVIF).');
