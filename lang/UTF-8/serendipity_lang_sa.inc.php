...
@define('DO_MARKUP_DESCRIPTION', 'قم بتطبيق تحويلات الترميز (المكون الإضافي) على النص (الابتسامات ، و bbcode ، وعلامات الاختصار s9y ، والتخفيضات ، وما إلى ذلك). إذا تم تعطيله ، يتم عرض المحتوى بنسبة 1: 1 ويتم الاحتفاظ بأي تنسيق HTML. إذا تم تنشيط هذا الخيار ، يمكن للإضافات الأخرى تعديل محتويات الكتلة.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Since you have ignored the upgrade stage of Serendipity, please make sure your database is correctly installed or updated, and scheduled functions are run. بعد الانتهاء من عملك المسبب للتراجع، يمكن القيام بذلك تلقائيًا بمجرد إعادة تعيين الإصدار في ملف serendipity_config_local.inc الخاص بك وتشغيل صفحة الترقية هذه مرة أخرى عبر صفحة الواجهة الخلفية.');
...
@define('DELETE_DIRECTORY_DESC', 'أنت على وشك حذف دليل<sup>(¹)</sup> قد يحتوي على ملفات وسائط وعناصر مستخدمة بالفعل في إدخالاتك. تأكد!<br><sup>[¹]</sup> بما في ذلك القرص الفرعي المخفي الذي يحتوي على ملفات التباين (WebP/AVIF).');
@define('FORCE_DELETE', 'احذف جميع الملفات الموجودة في هذا الدليل، بما في ذلك الأدراج الفرعية والملفات غير المعروفة (حتى الآن) من قبل مكتبة الوسائط');
