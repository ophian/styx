...
@define('DELETE_DIRECTORY_DESC', 'You are about to delete a directory<sup>(¹)</sup> that may contain media files and items already used in your entries. Be sure!<sup>[¹]</sup> Including the hidden sub-dir with (WebP/AVIF) variation files.');
