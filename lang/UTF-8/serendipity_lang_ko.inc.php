...
@define('DELETE_DIRECTORY_DESC', '응모작에 이미 사용된 미디어 파일과 항목이 포함되어 있을 수 있는 디렉토리<sup>(¹)</sup>를 삭제하려고 합니다. 반드시!<br><sup>[¹]</sup> 숨겨진 하위 디렉터리에 (WebP/AVIF) 변형 파일이 포함되어 있는지 확인하세요.');
...
@define('UPDATE_NOTIFICATION_DESC', '대시보드에 업데이트 알림을 표시하고, 어떤 채널에 나타내겠습니까? 베타에는 안정 릴리스가 포함됩니다.');
@define('FRONTEND', '외부 페이지');
@define('BACKEND', '관리 페이지');
@define('MEDIA_UPLOAD_RESIZE', '업로드 시 크기 조정');
...
@define('CONFIG_PERMALINK_PATH_DESC', '세렌디피티가 주소(URL)와 작업을 제대로 연동시킬 수 있도록 반드시 접두사를 지정해야 한다는 점에 유의하기 바랍니다. 접두사는 고유한 이름이면 아무렇게나 지정할 수 있지만 비워둘 수는 없습니다. 이는 모든 접두사 지정사항에 대해 동일하게 적용됩니다. Also note that this unique ASCII name is not already used elsewhere in your URL path to the blog.');
