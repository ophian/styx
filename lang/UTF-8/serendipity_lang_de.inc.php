...
@define('ENTRY_PAGE_PASSWORD_INFO_SET', 'Artikel-Passwörter sind - anders als Login-Passwörter - unverschlüsselt, also einfach und ungesichert gespeichert. Sie sollten damit kein sicherheitsrelevantes Zugangssystem betreiben wollen!');
