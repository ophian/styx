...
@define('INSTALL_CSS_CTAPPENDIX', 'Serendipity CSS-Cache Kontrolle verwenden');
@define('INSTALL_CSS_CTAPPENDIX_DESC', 'Meldet Änderungen des Zeitstempels "last_template_change" (CSS) an Browser-Caches. Standardmäßig auf "<b>Ja</b>" eingestellt.<br><br><b>NOTE:</b> Auf bestimmten Systemen, unter Verwendung von erweiternden Cache-Servern, insbesondere aber mit "LiteSpeed Cache", wurden Probleme mit FOUC (<em>Flash of Unstyled Content</em>) auf Chromium/Safari-Browsern gemeldet, die die CSS-Datei nach Erreichen des Zeitlimits des Cache-Servers, zB. nach 30 Minuten, nicht (erneut) laden, ohne dass dies auf Benutzerseite mit "<em>[Strg]+Aktualisierung</em>" erzwungen wird. Dann hilft es, diese Option auf "<b>Nein</b>" zu setzen, so dass diese Browser die zuvor gespeicherte Datei so lange verwenden, wie sie sie selber intern bereit halten. Mozilla Firefox hat dieses Problem nicht. Wenn Ihr Blog also mit diesem Problem konfrontiert ist - und alle Einstellungen dem künftigen Auslieferungs-Standard entsprechen - kann dies Ihren Besuchern vorläufig helfen, bis dieses Problem oder dieser Fehler allgemein behoben ist. Setzen sie dazu dann eine abgespeicherte Version der aktuellen "serendipity.css" und der "serendipity_admin.css" in das root Verzeichnis ihres Blogs.');
