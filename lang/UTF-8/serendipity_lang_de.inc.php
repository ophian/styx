...
@define('ENABLEAVIF_DESC', 'Image AVIF Variationen können sehr ressourcenintensiv sein, da viel Ram und CPU/GPU Kerne benötigt werden um Bilder in das AV1 Format zu kodieren. Massenuploads und Massenkonvertierungen (siehe "Wartung") sind daher nicht zu empfehlen. Erlernen Sie den Umgang an ein paar Beispielen, bevor Sie die Nutzung verbleibend erlauben. PHP 8.1 fehlen noch ein paar entscheidende Funktionen um Größenangaben mit den üblichen Methoden aus AVIF Dateien auszulesen. Dies bedingt vorläufig auch, dass die Bild-Funktionen der Mediathek "Dateiausmaße ändern" und "Bild um 90° drehen" für alle Formate nicht verwendet werden können, wenn Sie AVIF verwenden, da ja jede dieser Aktionen das Originalbild, sowie dessen Variationen betrifft.');
