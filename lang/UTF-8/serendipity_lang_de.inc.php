...
@define('CANT_EXECUTE_EXTENSION', 'Kann die %s Erweiterung nicht ausführen. Bitte in PHP.ini aktivieren oder das fehlende Modul durch den Package Manager des Servers laden.');
