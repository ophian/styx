...
@define('DIRECTORY_INFO_DESC', 'Verzeichnisse spiegeln ihren physikalischen Verzeichnis Namen. Wenn Sie Verzeichnisse ändern oder verschieben wollen, welche bereits Elemente enthalten, haben Sie zwei Möglichkeiten: Entweder erstellen Sie vorher das benötigte Verzeichnis oder Unterverzeichnis und verschieben dann die Elemente über die Medienbibliothek in das neue Verzeichnis und löschen danach das leere alte Verzeichnis. Oder, Sie ändern den Namen des alten Verzeichnisses einfach über die unten gegebene Schaltfläche "Verzeichnis Bearbeiten" und benennen es um (zB. A/B/ zu A/C/). Dadurch werden alle Verzeichnisse und Elemente verschoben und verweisende Blog-Einträge entsprechend geändert.');
