...
@define('DIRECTORY_INFO_DESC', 'Directories reflect their physical folders directory name. If you want to change or move directories that contain items, you have two options. Either you create the desired directory or subdirectory, move the items to the new directory via the MediaLibrary and then delete the empty old directory here. Or you can directly change the entire old directory using the "Edit directory" button below and rename it to a directory of your choice (i.e. existing subdir/ + newname/). This will move all subdirectories and elements and change any referring Blog entries to the new location.');
