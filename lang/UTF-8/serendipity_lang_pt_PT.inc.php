...
@define('THUMB_CREATED_DONE', 'Miniatura %s criada.<br>Pronto.'); // ADD: and of all variations
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Você ignorou a fase de actualização do Serendipity, certifique-se de que a base de dados está instalada correctamente e que as funções necessárias foram executadas. Depois de ter terminado o seu trabalho fundamentado para o hold-back, isto pode ser feito automaticamente, bastando repor a versão no seu ficheiro serendipity_config_local.inc e executar novamente esta página de atualização através da sua página backend.');
...
@define('INSTALL_DBPREFIX_DESC', 'Prefixo utilizado para designar as tabelas, ex.: styx_');
...
@define('POWERED_BY_SHOW_TEXT', 'Exibir "%s" como texto');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Exibirá o "Serendipity Styx Weblog" como texto');
@define('POWERED_BY_SHOW_IMAGE', 'Exibir "%s" como um logotipo');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Exibe o logotipo do %s');
...
@define('PGSQL_REQUIRED', 'Tem que ter a extensão PostgreSQL para poder executar esta acção.');
@define('COULDNT_CONNECT', 'Foi impossível ligar à base de dados MySQL: %s.');
@define('PGSQL_COULDNT_CONNECT', 'Foi impossível ligar à base de dados PostgreSQL: %s.');
...
@define('DELETE_DIRECTORY_DESC', 'Está prestes a eliminar um diretório<sup>(¹)</sup> que pode conter ficheiros multimédia e itens já utilizados nas suas entradas. Certifique-se!<br><sup>[¹]</sup> Incluindo o subdiretor oculto com ficheiros de variação (WebP/AVIF).');
...
@define('DIRECTORY_INFO_DESC', 'Directories reflect their physical folders directory name. If you want to change or move directories that contain items, you have two options. Either you create the desired directory or subdirectory, move the items to the new directory via the MediaLibrary and then delete the empty old directory here. Or you can directly change the entire old directory using the "Edit directory" button below and rename it to a directory of your choice (i.e. A/B/ to A/C/). This will move all subdirectories and elements and change any referring Blog entries to the new location.');
