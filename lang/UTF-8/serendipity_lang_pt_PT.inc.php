...
@define('THEMEMANAGER_INFO', 'Multi-select and purge old theme zombies. Make me happy and delete this old crap! :) If you ever need it again just load it with Spartacus, to get the last maintained fresh version.');
