...
@define('IMAGESYNC_WARNING', 'FIGYELEM:<br>Ez sokáig eltarthat, ha csak kevés képnek van elõnézeti képe. Particularly with migrations of old blogs, further preliminary considerations and knowledge are necessary! Read about it on <a href="https://ophian.github.io/hc/en/media-migration-tasks.html" target="_new">this help page</a>, carefully.');
...
@define('PGSQL_REQUIRED', 'Ezen mûvelet végrehajtásához szükség van a PostgreSQL kiterjesztésre.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'A Serendipity frissítésének fázisát figyelmen kívül hagytad, ellenõrizd hogy az adatbázis megfelelõen van installálva, és az idõzített feladatok futnak. Miután befejezte a visszatartásra vonatkozó indokolt munkáját, ez automatikusan elvégezheto, ha csak visszaállítja a verziót a serendipity_config_local.inc fájlban, és újra lefuttatja ezt a frissítési oldalt a backend oldalon keresztül.');
...
@define('ADD_MEDIA_BLAHBLAH', '<b>Fájl hozzáadása a média tárolóhoz:</b><p>Itt tölthetsz fel médiafájlokat, vagy megmondhatod hogy honnan töltsem le õket! Ha nincs meg egy bizonyos kép, <a href="https://images.google.com" rel="noopener" target="_blank">keress rá a Google-t használva</a> az elképzelésednek megfelelõen. Az eredmények gyakran hasznosak és viccesek :) De vigyázz, a legtöbb kép szerzõi jogvédelem alatt áll, így mielõtt használnád kérdezz rá.</p><p><b>Válassz a lehetõségek közül:</b></p><br>');
...
@define('INSTALL_DBPERSISTENT_DESC', 'Engedélyezd az állandó adatábziskapcsolat használatához. <a href="https://php.net/manual/features.persistent-connections.php" rel="noopener" target="_blank">Itt olvashatsz errõl többet</a>. Normális esetben ez nem szükséges');
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Itt saját szöveget adhatsz meg, ami megjelenik a modul beállító képernyõn a modulnál a leírással együtt. Ha több stacked plugins / HTML Nugget létezik cím nélkül, ez segíthet õket megkülönböztetni.');
...
@define('PERMISSION_ADMINUSERSMAINTAINSAME', 'adminUsersMaintainSame: A csoportodban lévõ felhasználók adminisztrálása');
...
@define('MEDIA_PROPERTY_COMMENT2', 'Belso megjegyzés');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Ha ezt engedélyezed, a serendipity_admin_image_selector.php file megadott méretûre konvertálj a hivatkozozz képeket. Az eredmények eltárolásra kerülnek. Így ha ezt sûrûn használod, sok fájlod összegyûlhet.');
