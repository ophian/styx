...
@define('COMMENT_ADDED', '您的迴響%s已成功增入.');
...
@define('DELETE_DIRECTORY_DESC', '您將要刪除目錄<sup>(1)</sup>，該目錄可能包含您的條目中已使用的媒體檔案和項目。 請務必！<br><sup>[1]</sup> 包括帶有 (WebP/AVIF) 變體檔案的隱藏子目錄。');
