...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Täällä voit säätää kuvan kokoa. Jos haluat muuttaa kuvan kokoa suhteellisesti, kirjoita arvo johonkin kahdesta ruudusta ja paina TAB- tai hiiren näppäintä. Uusi koko lasketaan automaattisesti, jotta kuvan mittasuhteet eivät muutu. <p><b>HUOMAA:</b> Tämä ei ole korkealaatuinen kuvankäsittelyohjelman koonmuokkaustyökalu, joka on hienosäädetty tietyn kuvan tarpeisiin. <br>Jokainen skaalaus heikentää kuvan laatua enemmän tai vähemmän verrattuna alkuperäiseen tiedostoon. Ja tämä heikkeneminen kasvaa jokaisen skaalauksen myötä!</p>');
...
@define('CANT_EXECUTE_BINARY', '%s-binaaripolkua ei voi suorittaa (ei pakollista, kun käytetään laajennusmoduulia)');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Jätit automaattipäivitykset väliin. Varmista, että kanta on oikein asennettu ja oikeat skriptat on ajettu. Kun olet saanut valmiiksi perustellun työsi pidättämistä varten, tämä voidaan tehdä automaattisesti vain nollaamalla versio serendipity_config_local.inc-tiedostossasi ja suorittamalla tämä päivityssivu uudelleen backend-sivun kautta.');
...
@define('POWERED_BY_SHOW_TEXT', 'Näytä "%s" tekstinä');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Tulostaa "Serendipity Styx Weblog" tekstinä');
@define('POWERED_BY_SHOW_IMAGE', 'Näytä "%s" logolla');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Näyttää %s-logon');
...
@define('DELETE_DIRECTORY_DESC', 'Olet poistamassa hakemistoa<sup>(¹)</sup>, joka saattaa sisältää mediatiedostoja ja kohteita, joita on jo käytetty merkinnöissäsi. Varmista!<br><sup>[¹]</sup> Mukaan lukien piilotettu alihakemisto, jossa on (WebP/AVIF) muunnostiedostoja.');
...
@define('ERROR_XSRF', 'Selaimesi ei lähettänyt kelvollista HTTP-Referrer-merkkijonoa. Viittaajan osalta tämä on voinut johtua joko väärin määritetystä selaimesta tai välityspalvelimesta tai sinuun kohdistuneesta Cross Site Request Forgery (XSRF) -haittaohjelmasta. Muussa tapauksessa tämä viesti voi vain osoittaa, että välilehti on ollut auki liian kauan ja nykyinen muokkausmerkki on vanhentunut. Pyytämääsi toimenpidettä ei voitu suorittaa loppuun.');
