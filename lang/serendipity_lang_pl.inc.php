...
@define('DO_MARKUP_DESCRIPTION', 'Zastosuj (plugin) transformacje znaczników do tekstu (usmieszki, bbcode, skróty s9y, markdown, itp.). Jesli opcja jest wylaczona, tresc jest renderowana 1:1, a wszelkie formatowanie HTML jest zachowane. Jesli ta opcja jest wlaczona, inne wtyczki moga modyfikowac zawartosc brylki.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Zignorowa³e¶(a¶) etap uaktualnienia Serendipity. Proszê, upewnij siê, ¿e Twoja baza danych jest prawid³owo zainstalowana a zaplanowane zadania zostan± uruchomione. Po zakonczeniu uzasadnionej pracy nad wstrzymaniem mozna to zrobic automatycznie, po prostu resetujac wersje w pliku serendipity_config_local.inc i ponownie uruchamiajac te strone aktualizacji za posrednictwem strony zaplecza.');
...
@define('POWERED_BY_SHOW_TEXT', 'Poka¿ "%s" jako tekst');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Poka¿e "Serendipity Styx Weblog" jako tekst');
@define('POWERED_BY_SHOW_IMAGE', 'Poka¿ "%s" jako logo');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Poka¿e logo %s (obrazek)');
...
@define('USERCONF_USERLEVEL_DESC', 'To ustawienie okre¶la jaki poziom dostêpu ma u¿ytkownik do bloga. Uprawnienia uzytkowników sa obslugiwane przez przynaleznosc do grup!');
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Tu mo¿esz podaæ dodatkowy opis, który bêdzie wy¶wietlany na stronie Konfiguracji Wtyczek razem z pluginem. Przydatne kiedy posiadasz kilka takich stacked plugins / HTMLowych wstawek, pozwala siê jako¶ w tym wszystkim po³apaæ.');
