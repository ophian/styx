...
@define('DATE_LOCALES', 'pl_PL.UTF-8, pl_PL.UTF8, polish, pl, pl_PL');
@define('DATE_FORMAT_ENTRY', '%A, %B %e. %Y');
@define('DATE_FORMAT_SHORT', '%Y-%m-%d %H:%M');
@define('WYSIWYG_LANG', 'pl_PL');
@define('TINYMCE_LANG', 'pl');
...
@define('RESIZE_BLAHBLAH', 'Zmień rozmiar: %s');
@define('ORIGINAL_SIZE', 'Oryginalny rozmiar: <i>%sx%s</i> pikseli');
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'W tym miejscu można dostosować rozmiar obrazu. Jeśli chcesz zmienić rozmiar obrazu proporcjonalnie, po prostu wprowadź wartość w jednym z dwóch pól i naciśnij klawisz TAB lub przycisk myszy — nowy rozmiar zostanie obliczony automatycznie, tak aby proporcje obrazu nie uległy zmianie. <p><b>UWAGA:</b> Nie jest to zaawansowane narzędzie do zmiany rozmiaru obrazu, dostosowane do potrzeb konkretnego obrazu. Każda zmiana skali powoduje mniej lub bardziej zauważalną utratę jakości obrazu w porównaniu z oryginalnym plikiem wejściowym. Utrata ta wzrasta wraz z każdą kolejną zmianą skali!</p>');
...
@define('COMMENT_ADDED', 'Twój komentarz %szostał dodany.');
...
@define('CANT_EXECUTE_BINARY', 'Nie można wykonać ścieżki binarnej %s (nie jest to wymagane w przypadku korzystania z modułu rozszerzenia)');
...
@define('FILE_NOT_FOUND', 'Nie można odnalzeźć pliku %s. Być może został już usunięty?');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Zignorowałeś(aś) etap uaktualnienia Serendipity. Proszę, upewnij się, że Twoja baza danych jest prawidłowo zainstalowana a zaplanowane zadania zostaną uruchomione. Po zakończeniu uzasadnionej pracy nad wstrzymaniem można to zrobić automatycznie, po prostu resetując wersję w pliku serendipity_config_local.inc i ponownie uruchamiając tę stronę aktualizacji za pośrednictwem strony zaplecza.');
...
@define('INSTALL_DBPASS_DESC', 'Hasło dla użytkownika podanego powyżej. Jeśli jest już ustawiony, istnieje tylko w pliku dostępu "serendipity_config_local.inc" lub można go ustawić tutaj.');
...
@define('DELETE_FILE_FAIL', 'Usuwanie pliku %s nie powiodło się');
@define('DELETE_THUMBNAIL', 'Usunięto minturkę o nazwie %s');
@define('DELETE_FILE', 'Usunięto plik o nazwie %s');
...
@define('INSTALL_DBPERSISTENT_DESC', 'Zezwól na używanie stałych połączeń z bazą danych, więcej <a href="https://pl.php.net/manual/pl/features.persistent-connections.php" rel="noopener" target="_blank">tutaj</a>. Włączenie tej opcji nie jest zalecane.');
...
@define('PRE_INSTALLATION_REPORT', 'Serendipity Styx v.%s raport przed instalacją');
...
@define('STYLE_OPTIONS_NONE', 'Ten Styl nie posiada opcji specjalnych. Aby dowiedzieć się jak możesz zaimplementować w swoim Stylu opcje specjalne, odwiedź stronę "https://ophian.github.io/hc/en/templating.html#docs-theme-options" i przeczytaj w dziale Technical Documentation dokument zatytułowany "Configuration of Theme options".');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Jeśli włączone, moduł obsługi mediów może zwracac obrazki w dowolnej żądanej wielkości podawanej przez GET. Rezultaty zmian są buforowane i mogą spowodować spory rozrost bazy plików jeśli będzie ta opcja wykorzystywana intensywnie.'); //check translation
