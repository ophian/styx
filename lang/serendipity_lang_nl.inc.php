...
@define('THUMB_CREATED_DONE', 'Miniatuur %s gemaakt.<br>Gedaan.'); // ADD: and of all variations
...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Hier kunt u de afbeeldingsgrootte aanpassen. Als u de afbeelding proportioneel wilt vergroten of verkleinen, voert u gewoon een waarde in een van de twee vakjes in en drukt u op de TAB- of muistoets. De nieuwe grootte wordt automatisch berekend, zodat de verhoudingen van de afbeelding niet worden verstoord. <p><b>LET OP:</b> Dit is geen geavanceerde tool voor het aanpassen van de afbeeldingsgrootte, die is afgestemd op de behoeften van een specifieke afbeelding.<br>Elke schaalverandering gaat gepaard met een min of meer toenemend verlies aan beeldkwaliteit in vergelijking met het oorspronkelijke invoerbestand. En dit neemt toe bij elke verdere schaalverandering!</p>');
...
@define('INSTALL_WYSIWYG', 'RichText (WYSIWYG) editor gebruiken');
@define('INSTALL_WYSIWYG_DESC', 'Deze editor wordt gebruikt in veelgebruikte tekstvelden zoals invoerschermen, statische pagina\'s, commentaar (met een extra globale optie-instelling) en enkele andere plugin-plaatsen; HTML-opmaak wordt direct opgeslagen.');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Heb je de ImageMagick-binaire bibliotheek of de Imagick-module geïnstalleerd en wil je deze gebruiken om afbeeldingen te verkleinen?');
...
@define('WELCOME_TO_INSTALLATION', 'Welkom bij de Serendipity Styx-installatie');
...
@define('YELLOW', 'geel');
@define('GREEN', 'groen');
@define('PRE_INSTALLATION_REPORT', 'Serendipity Styx v.%s pre-installatiebericht');
...
@define('ERROR_XSRF', 'Je browser heeft geen geldige HTTP-Referrer-string verzonden. Voor de Referrer kan dit worden veroorzaakt door een verkeerd geconfigureerde browser/proxy of door een Cross Site Request Forgery (XSRF) die op jou is gericht. In andere gevallen kan dit bericht alleen aangeven dat je tabblad te lang open heeft gestaan en dat je huidige bewerkingstoken is verlopen. De gevraagde actie kon niet worden voltooid.');
