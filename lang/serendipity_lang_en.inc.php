...
@define('COMMENT_ADDED', 'Your comment %swas successfully added.');
...
@define('CANT_EXECUTE_BINARY', 'Cannot execute the %s binary path (not mandatory when using the extension module)');
...
@define('INSTALL_DBPASS_DESC', 'The password matching the above username. If already set, it only exists in the access "serendipity_config_local.inc" file, or can be re-set here.');
...
@define('INSTALL_DBPREFIX_DESC', 'Prefix for the table names, e.g. styx_');
...
@define('INSTALL_WYSIWYG', 'Use RichText (WYSIWYG) editor');
@define('INSTALL_WYSIWYG_DESC', 'This editor will then be used in common textarea fields like entry forms, staticpages, comments (which has an additional global option setting) and some other plugin places; It stores HTML markup directly.');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Do you have the ImageMagick binary library or the Imagick module installed and want to use it to resize images?');
...
@define('DELETE_DIRECTORY_DESC', 'You are about to delete a directory<sup>(¹)</sup> that may contain media files and items already used in your entries. Be sure!<br><sup>[¹]</sup> Including the hidden sub-dir with (WebP/AVIF) variation files.');
