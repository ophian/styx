...
@define('DELETE_DIRECTORY_DESC', 'شما در شرف حذف دایرکتوری هستید که ممکن است حاوی فایل های رسانه ای و مواردی باشد که قبلاً در ورودی های شما استفاده شده است. مطمئن باش!');
