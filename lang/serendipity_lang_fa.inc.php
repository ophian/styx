...
@define('DELETE_DIRECTORY_DESC', 'شما در شرف حذف دایرکتوری <sup>(¹)</sup> هستید که ممکن است حاوی فایل های رسانه ای و مواردی باشد که قبلاً در ورودی های شما استفاده شده است. مطمئن باشید!<sup>[¹]</sup> از جمله زیرمجموعه پنهان با فایل‌های تنوع (WebP/AVIF).');
