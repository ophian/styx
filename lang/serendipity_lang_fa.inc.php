...
@define('ERROR_XSRF', 'مرورگر شما یک رشته HTTP-Referrer معتبر ارسال نکرده است. در شرایط جدی برای ارجاع‌دهنده، این مشکل ممکن است یا به دلیل پیکربندی نادرست مرورگر/پروکسی یا به دلیل جعل درخواست میان‌سایتی (XSRF) که شما را هدف قرار داده است، رخ داده باشد. در غیر این صورت، این پیام فقط می‌تواند نشان دهد که برگه شما مدت زیادی باز بوده و توکن ویرایش فعلی شما منقضی شده است. عملی که درخواست کرده‌اید قابل انجام نیست.');
