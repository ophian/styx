...
@define('DELETE_DIRECTORY_DESC', 'Вы собираетесь удалить каталог<sup>(¹)</sup>, который может содержать медиафайлы и элементы, уже использованные в ваших записях. Убедитесь в этом!<sup>[¹]</sup> Включая скрытый подкаталог с файлами вариаций (WebP/AVIF).');
