...
@define('DELETE_DIRECTORY_DESC', 'Вы собираетесь удалить каталог, который может содержать медиафайлы и элементы, уже использованные в ваших записях. Будьте уверены!');
