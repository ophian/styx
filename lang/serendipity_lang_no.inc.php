...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Du har ignorert en del av oppgraderingen. Vennligst undersøk hvorvidt databasen er korrekt opdatert, og planlagte opgaver utført. Når du er ferdig med begrunnelsen for å holde tilbake, kan dette gjøres automatisk ved å tilbakestille versjonen i filen serendipity_config_local.inc og kjøre oppgraderingssiden på nytt via backend-siden.');
...
@define('INSTALL_DBPREFIX_DESC', 'Prefiks på tabellnavn, f.eks. styx_');
