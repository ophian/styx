...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Her kan du justere bildestørrelsen. Hvis du vil endre størrelsen på bildet proporsjonalt, skriver du bare inn en verdi i en av de to boksene og trykker på TAB- eller musetasten. Den nye størrelsen beregnes automatisk, slik at bildets proporsjoner ikke blir ødelagt. <p><b>VIKTIG:</b> Dette er ikke et avansert verktøy for endring av bildestørrelse, som er finjustert for behovene til et bestemt bilde.<br>Hver skalering medfører en mer eller mindre økende tap av bildekvalitet sammenlignet med den opprinnelige inndatafilen. Og dette øker for hver ytterligere skalering!</p>');
...
@define('CANT_EXECUTE_BINARY', 'Kan ikke utføre %s binærsti (ikke obligatorisk når du bruker utvidelsesmodulen)');
...
@define('INSTALL_DBPASS_DESC', 'Passordet som passer til brukernavnet over. Hvis den allerede er angitt, finnes den bare i filen "serendipity_config_local.inc", eller kan angis her.');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Har du ImageMagick-binærbiblioteket eller Imagick-modulen installert og ønsker å bruke det til å endre størrelsen på bilder?');
