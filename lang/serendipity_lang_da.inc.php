...
@define('DATE_LOCALES', 'da_DK.UTF-8, da_DK.UTF8, danish, da, da_DK');
...
@define('RESIZE_BLAHBLAH', 'Ændre størrelse på %s');
@define('ORIGINAL_SIZE', 'Original størrelse: <i>%sx%s</i> pixel');
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Her kan du justere billedstørrelsen. Hvis du vil ændre billedets størrelse proportionalt, skal du blot indtaste en værdi i et af de to felter og trykke på TAB- eller musetasten. Den nye størrelse beregnes automatisk, så billedets proportioner ikke ødelægges. <p><b>BEMÆRK:</b> Dette er ikke et avanceret billedredigeringsværktøj til ændring af størrelse, der er finjusteret til behovet for et bestemt billede. <br>Hver skalering medfører et mere eller mindre stigende tab af billedkvalitet i forhold til den oprindelige indgangsfilen. Og dette øges med hver yderligere skalering!</p>');
...
@define('CANT_EXECUTE_BINARY', 'Kan ikke udføre %s binær sti (ikke obligatorisk ved brug af udvidelsesmodulet)');
...
@define('FILE_NOT_FOUND', 'Kunne ikke finde filen ved navn %s, måske er den allerede slettet?');
...
@define('DO_MARKUP_DESCRIPTION', 'Anvend (plugin) markup-transformationer på teksten (smilies, bbcode, s9y-genvejsmarkeringer, markdown osv.). Hvis den er deaktiveret, gengives indholdet 1:1, og enhver HTML-formatering bevares. Hvis denne indstilling er aktiveret, kan andre plugins ændre indholdet af nugget\'en.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Du har ignoreret en del af opgraderingen. Undersøg venligst om databasen er korrekt opdateret, og planlagte opgaver udført. Når du har afsluttet dit begrundede arbejde for at holde tilbage, kan dette gøres automatisk ved blot at nulstille versionen i din serendipity_config_local.inc-fil og køre denne opgraderingsside igen via din backend-side.');
...
@define('DELETE_FILE_FAIL', 'Kunne ikke slette filen %s');
@define('DELETE_THUMBNAIL', 'Slettede billedet ved navn %s');
@define('DELETE_FILE', 'Slettede filen ved navn %s');
@define('ABOUT_TO_DELETE_FILE', 'Du er ved at slette <b>%s</b><br>Hvis du benytter denne fil i nogle af dine artikler, vil det resultere i døde links eller billeder<br>Er du sikker på du vil fortsætte?');
...
@define('ADD_MEDIA_BLAHBLAH', '<b>Tilføj en fil til dit mediearkiv:</b><p>Her kan du uploade mediafiler, eller få dem hentet fra et sted på nettet. Hvis du ikke har et passende billeder, <a href="https://images.google.com" rel="noopener" target="_blank">prøv at søg efter billeder på Google</a> der passer til dine tanker, resultatet er ofte brugbart og sjovt :)</p><p><b>Vælg metode:</b></p><br>');
...
@define('YELLOW', 'gul');
@define('GREEN', 'grøn');
@define('PRE_INSTALLATION_REPORT', 'Serendipity Styx v.%s før-installations report');
...
@define('DELETE_DIRECTORY_DESC', 'Du er ved at slette en mappe<sup>(¹)</sup>, der kan indeholde mediefiler og elementer, der allerede er brugt i dine poster. Vær sikker!<br><sup>[¹]</sup> Inklusive den skjulte undermappe med (WebP/AVIF) variationsfiler.');
...
@define('DELETE_HOTLINK_FILE', 'Slet den hotlinkede fil ved navn %s');
