...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'هنا، يمكنك ضبط حجم الصورة. إذا كنت ترغب في تغيير حجم الصورة بشكل متناسب، ما عليك سوى إدخال قيمة في أحد المربعات واضغط على مفتاح TAB أو مفتاح الماوس -- سيتم حساب الحجم الجديد تلقائيًا حتى لا تتغير نسب الصورة. <p><b>يرجى ملاحظة:</b> هذه ليست أداة متطورة لتغيير حجم الصور، تم ضبطها بدقة لتلبية احتياجات صورة معينة.<br>كل تغيير في الحجم يؤدي إلى فقدان جودة الصورة بشكل أو بآخر مقارنة بالملف الأصلي المدخل. ويزداد هذا الفقدان مع كل تغيير في الحجم!</p>');
