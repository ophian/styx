...
@define('THUMB_CREATED_DONE', '«·’Ê—… %s «·„’€—…<br>Ã«Â“…'); // ADD: and of all variations
...
@define('COMMENT_ADDED', ' „  ≈÷«›…  ⁄·Ìﬁﬂ?s »‰Ã«Õ.');
...
@define('DO_MARKUP_DESCRIPTION', 'ﬁ„ » ÿ»Ìﬁ  ÕÊÌ·«  «· —„Ì“ («·„ﬂÊ‰ «·≈÷«›Ì) ⁄·Ï «·‰’ («·«» ”«„«  ° Ê bbcode ° Ê⁄·«„«  «·«Œ ’«— s9y ° Ê«· Œ›Ì÷«  ° Ê„« ≈·Ï –·ﬂ). ≈–«  „  ⁄ÿÌ·Â ° Ì „ ⁄—÷ «·„Õ ÊÏ »‰”»… 1: 1 ÊÌ „ «·«Õ ›«Ÿ »√Ì  ‰”Ìﬁ HTML. ≈–«  „  ‰‘Ìÿ Â–« «·ŒÌ«— ° Ì„ﬂ‰ ··≈÷«›«  «·√Œ—Ï  ⁄œÌ· „Õ ÊÌ«  «·ﬂ ·….');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Since you have ignored the upgrade stage of Serendipity, please make sure your database is correctly installed or updated, and scheduled functions are run. »⁄œ «·«‰ Â«¡ „‰ ⁄„·ﬂ «·„”»» ·· —«Ã⁄° Ì„ﬂ‰ «·ﬁÌ«„ »–·ﬂ  ·ﬁ«∆Ì« »„Ã—œ ≈⁄«œ…  ⁄ÌÌ‰ «·≈’œ«— ›Ì „·› serendipity_config_local.inc «·Œ«’ »ﬂ Ê ‘€Ì· ’›Õ… «· —ﬁÌ… Â–Â „—… √Œ—Ï ⁄»— ’›Õ… «·Ê«ÃÂ… «·Œ·›Ì….');
...
@define('SUCCESS', '‰Ã«Õ');
@define('POWERED_BY_SHOW_TEXT', '√⁄—÷ «·„Ã·… ⁄·Ï ÂÌ∆… ‰’  ﬂ” '); // should be 'Show "%s" as text'
@define('POWERED_BY_SHOW_TEXT_DESC', '”Ê› Ì „ ⁄—÷ «·„Ã·… ⁄·Ï ÂÌ∆… ‰’  ﬂ” '); // Serendipity should be Serendipity Styx
@define('POWERED_BY_SHOW_IMAGE', '√⁄—÷ «·„Ã·… „⁄ «·‘⁄«— «·Œ«’ »Â«'); // should be 'Show "%s" with a logo'
@define('POWERED_BY_SHOW_IMAGE_DESC', '√⁄—÷ ‘Â«— «·„Ã·…'); // should be 'Displays the %s-logo'
...
@define('DELETE_DIRECTORY_DESC', '√‰  ⁄·Ï Ê‘ﬂ Õ–› œ·Ì·<sup>(π)</sup> ﬁœ ÌÕ ÊÌ ⁄·Ï „·›«  Ê”«∆ÿ Ê⁄‰«’— „” Œœ„… »«·›⁄· ›Ì ≈œŒ«·« ﬂ.  √ﬂœ!<br><sup>[π]</sup> »„« ›Ì –·ﬂ «·ﬁ—’ «·›—⁄Ì «·„Œ›Ì «·–Ì ÌÕ ÊÌ ⁄·Ï „·›«  «· »«Ì‰ (WebP/AVIF).');
@define('FORCE_DELETE', '«Õ–› Ã„Ì⁄ «·„·›«  «·„ÊÃÊœ… ›Ì Â–« «·œ·Ì·° »„« ›Ì –·ﬂ «·√œ—«Ã «·›—⁄Ì… Ê«·„·›«  €Ì— «·„⁄—Ê›… (Õ Ï «·¬‰) „‰ ﬁ»· „ﬂ »… «·Ê”«∆ÿ');
...
@define('CONVERT_HTMLENTITIES', 'Ã—»  ÕÊÌ· «·„Ê«÷Ì⁄ ≈·Ï Â „·ø'); // Translate again
