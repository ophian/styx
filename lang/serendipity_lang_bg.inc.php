...
@define('SERENDIPITY_ADMIN_SUITE', 'Администриране на Serendipity Styx');
...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Тук можете да настроите размера на изображението. Ако искате да промените размера на изображението пропорционално, просто въведете стойност в едно от двете полета и натиснете клавиша TAB или мишката - той автоматично ще изчисли новия размер, така че пропорциите на изображението да не се нарушат. <p><b>МОЛЯ, ОБЪРНЕТЕ ВНИМАНИЕ:</b> Това не е високотехнологичен инструмент за промяна на размера на изображенията, оптимизиран за нуждите на конкретно изображение. <br>Всяко мащабиране води до повече или по-малко загуба на качеството на изображението в сравнение с оригиналния файл. И това се увеличава с всяко следващо мащабиране!</p>');
...
@define('COMMENT_ADDED', 'Коментарът %sВи беше добавен успешно.');
...
@define('CANT_EXECUTE_BINARY', 'Не може да се изпълни бинарният път %s (не е задължително при използване на разширителния модул)');
...
@define('DO_MARKUP_DESCRIPTION', 'Прилагане на трансформации (плъгин) за маркиране на текста (усмивки, bbcode, маркиране на съкращения в s9y, markdown и т.н.). Ако е изключено, съдържанието се визуализира 1:1 и се запазва всяко HTML форматиране. Ако тази опция е активирана, други плъгини могат да променят съдържанието на самолета.');
...
@define('INSTALL_DBPASS_DESC', 'Паролата на горния потребител. Ако вече е зададена, тя съществува само във файла за достъп "serendipity_config_local.inc" или може да бъде зададена тук.');
...
@define('INSTALL_DBPREFIX_DESC', 'Представка на имената на таблиците, напр. styx_');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Имате ли инсталирана бинарната библиотека ImageMagick или модула Imagick и искате да ги използвате за промяна на размера на изображенията?');
...
@define('POWERED_BY_SHOW_TEXT', 'Показване на "%s" като текст');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Показване на "Serendipity Styx Weblog" като текст');
@define('POWERED_BY_SHOW_IMAGE', 'Показване на "%s" като лого');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Показване на логото на %s');
...
@define('ADD_MEDIA_BLAHBLAH', '<b>Добавяне на файл към хранилището на медиа:</b><p>Тук можете да качвате файлове с медиа или да укажете място в мрежата, откъдето да се изтеглят! Ако нямате подходящо изображение, <a href="https://images.google.com" rel="noopener" target="_blank">търсете изображения с Google</a>, които отговарят на целите ви. Резултатите често са полезни и забавни :)</p><p><b>Изберете начин:</b></p><br>');
...
@define('WELCOME_TO_INSTALLATION', 'Добре дошли в инсталатора на Serendipity Styx');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx е инсталиран успешно');
@define('VISIT_BLOG_HERE', 'Посетете вашия нов блог оттук');
@define('THANK_YOU_FOR_CHOOSING', 'Благодарим ви, че избрахте Serendipity Styx');
...
@define('DELETE_DIRECTORY_DESC', 'Предстои да изтриете директория<sup>(¹)</sup>, която може да съдържа мултимедийни файлове и елементи, вече използвани във вашите записи. Бъдете сигурни!<br><sup>[¹]</sup> Включително скритата поддиректория с (WebP/AVIF) файлове с варианти.');
@define('FORCE_DELETE', 'Изтриване на ВСИЧКИ файлове в тази директория, включително поддиректориите и файловете, които (все още) не са известни на MediaLibrary');
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Тук можете да зададете кратък потребителски низ, който се показва в екрана за конфигуриране на плъгина заедно с описанието на плъгина. Ако имате няколко подредени плъгина или HTML приставки с празно заглавие, това помага за разграничаване на приставките една от друга.');
...
@define('ERROR_XSRF', 'Вашият браузър не е изпратил валиден низ за HTTP-референт. По отношение на препращащото лице това може да е причинено от неправилно конфигуриран браузър/прокси сървър или от фалшифициране на заявки от други сайтове (Cross Site Request Forgery - XSRF), насочено към вас. В противен случай това съобщение може само да показва, че табът ви е бил отворен твърде дълго и текущият ви токен за редактиране е изтекъл. Заявеното от вас действие не може да бъде завършено.');
...
@define('INSTALL_DB_UTF8', 'Разрешаване на прекодирането на символите при работа с MySQL база данни');
@define('INSTALL_DB_UTF8_DESC', 'Специално за MySQL. Отговор \'Да\' изпълнява \'SET NAMES\', за да определи кодирането на символите в базата данни. Включете или изключете тази опция, ако виждате нечетими символи в статиите.');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Ако е разрешено, при избиране на медийни файлове може да бъдат върнати изображения в различни размери през променлива GET. Резултатите се кешират и така да се създадат много файлове при интензивна употреба.'); //check translation
