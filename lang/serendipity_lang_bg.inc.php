...
@define('DELETE_DIRECTORY_DESC', 'Предстои да изтриете директория<sup>(1)</sup>, която може да съдържа мултимедийни файлове и елементи, вече използвани във вашите записи. Бъдете сигурни!<br><sup>[1]</sup> Включително скритата поддиректория с (WebP/AVIF) файлове с варианти.');
