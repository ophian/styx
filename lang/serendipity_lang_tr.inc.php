...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Burada, görüntü boyutunu ayarlayabilirsiniz. Görüntüyü orantılı olarak yeniden boyutlandırmak istiyorsanız, iki kutudan birine bir değer girin ve TAB veya Fare tuşuna basın. Görüntünün oranları bozulmasın diye yeni boyut otomatik olarak hesaplanacaktır. <p><b>LÜTFEN DİKKAT:</b> Bu, belirli bir görüntünün ihtiyacına göre ince ayarlanmış, yüksek kaliteli bir görüntü düzenleyici yeniden boyutlandırma aracı değildir. Her ölçeklendirme, orijinal giriş dosyasına kıyasla görüntü kalitesinde az ya da çok bir kayıp ile sonuçlanır. Ve bu, her ölçeklendirme ile daha da artar!</p>');
