...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', '在此處，您可以調整圖片尺寸。若需按比例調整圖片大小，只需在兩個輸入框中的任一處輸入數值，然後按下 TAB 鍵或滑鼠鍵——系統將自動計算新尺寸，確保圖片比例不被破壞。<p><b>請注意：</b>此工具並非針對特定圖像需求而優化的專業級編輯器。<br>每次縮放都會導致圖像品質相較原始檔案不同程度的損失，且隨縮放次數增加而加劇！</p>');
...
@define('SUBSCRIBE_TO_BLOG', '同步這個網誌');
...
@define('PGSQL_REQUIRED', '您必須要有 PostgreSQL 的擴充功能才能執行這個動作.');
@define('COULDNT_CONNECT', '不能聯結到 MySQL 資料庫: %s.');
@define('PGSQL_COULDNT_CONNECT', '不能聯結到 PostgreSQL 資料庫: %s.');
...
@define('CANT_EXECUTE_BINARY', '無法執行 %s 二進位路徑（使用擴充模組時非必要）');
...
@define('FILE_NOT_FOUND', '找不到檔案名稱 %s, 也許已經被刪除了?');
@define('ABORT_NOW', '放棄');
...
@define('SUCCESS', '完成');
@define('POWERED_BY_SHOW_TEXT', '以文字顯示 "%s"');
@define('POWERED_BY_SHOW_TEXT_DESC', '將用文字顯示 "Serendipity Styx Weblog"');
@define('POWERED_BY_SHOW_IMAGE', '以 logo 顯示 "%s"');
@define('POWERED_BY_SHOW_IMAGE_DESC', '顯示 %s 的 logo');
...
@define('DELETE_FILE_FAIL', '無法刪除檔案 %s');
@define('DELETE_THUMBNAIL', '刪除了圖片縮圖 %s');
@define('DELETE_FILE', '刪除了檔案 %s');
@define('ABOUT_TO_DELETE_FILE', '您將刪除檔案 <b>%s</b><br>如果您有在其他的文章內使用這個檔案, 那個連結或圖片將會無效<br>確定要繼續嗎?');
...
@define('WELCOME_TO_INSTALLATION', '歡迎到 Serendipity Styx 安裝程式');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx 已完成安裝');
@define('VISIT_BLOG_HERE', '參觀您的網路日誌');
@define('THANK_YOU_FOR_CHOOSING', '感謝您選擇 Serendipity Styx');
...
@define('DELETE_DIRECTORY_DESC', '您將要刪除目錄<sup>(¹)</sup>，該目錄可能包含您的條目中已使用的媒體檔案和項目。 請務必！<br><sup>[¹]</sup> 包括帶有 (WebP/AVIF) 變體檔案的隱藏子目錄。');
...
@define('DELETE_HOTLINK_FILE', '刪除外部連結的檔案 %s');
...
@define('MEDIA_PROPERTY_COMMENT1', '公眾意見');
@define('MEDIA_PROPERTY_COMMENT2', '內部評論');
...
@define('SYNDICATION_RFC2616_DESC', '不強制 RFC2616 表示全部有條件的 GETs 到 Serendipity 只會傳回最後修改的文章。如果設定為 "false" 表示訪客會接收全部的文章。不過，一些網誌的蒐集軟體像 Planet 會出現奇怪現象。如果出現奇怪現象表示它違反了 RFC2616 的標準。所以設定為 "TRUE" 表示你遵從 RFC 的標準，但是訪客可能會讀取不到全部的文章。整體來說，不管怎樣都無法顧到兩方。');
...
@define('PERMISSION_FORBIDDEN_PLUGINACL_ENABLE', '開啟外掛 ACL 給會員群組？');
@define('PERMISSION_FORBIDDEN_PLUGINACL_ENABLE_DESC', '如果 "外掛 ACL 給會員群組" 是開啟的狀態，您可以指定某些群組來執行外掛和事件。');
