...
@define('BACKEND_TITLE_FOR_NUGGET', 'Aqui você pode definir um texto personalizado que aparecerá na tela de configuração de plugin, junto com a descrição de HTML do plugin. Se você possui múltiplos stacked plugins / HTML nuggets com nome em branco, isto irá ajudar a separar uns dos outros.');//verify
