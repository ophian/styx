...
@define('DELETE_DIRECTORY_DESC', 'Você está prestes a excluir um diretório<sup>(¹)</sup> que pode conter arquivos de mídia e itens já usados em suas entradas. Certifique-se de incluir o subdiretório oculto com arquivos de variação (WebP/AVIF).');
