...
@define('COMMENT_ADDED', 'Váš komentáø %sbyl úspìšnì pøidán.');
...
@define('DO_MARKUP_DESCRIPTION', 'Pouijte (zásuvnı modul) transformace znacek na text (smajlíky, bbcode, znacky zkratek s9y, markdown atd.). Pokud je vypnuto, obsah se vykreslí 1:1 a veškeré formátování HTML zustane zachováno. Pokud je tato volba aktivována, mohou ostatní zásuvné moduly obsah samorostu upravovat.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vynechal jste stupeò upgrade Serendipity, ujistìte se, e databáze je správnì nainstalována a plánované funkce jsou spuštìny. Poté, co jste dokoncili zduvodnenou práci pro zadrení, lze toto provést automaticky pouhım resetováním verze v souboru serendipity_config_local.inc a opetovnım spuštením této aktualizacní stránky prostrednictvím vaší backendové stránky.');
...
@define('INSTALL_IMAGEDIM_WIDTH', 'Šíøka');
@define('INSTALL_IMAGEDIM_HEIGHT', 'Vıška');
...
@define('ABOUT_TO_DELETE_FILE', 'Chcete vymazat <b>%s</b><br>Jestlie pouíváte tento soubor v nìjakıch záznamech, zpùsobí to nepøístupnost odkazù nebo obrázkù.<br>Chcete pøesto pokraèovat?');
...
@define('DELETE_DIRECTORY_DESC', 'Chystáte se odstranit adresár<sup>(¹)</sup>, kterı mue obsahovat mediální soubory a poloky ji pouité v polokách. Ujistete se!<br><sup>[¹]</sup> Vcetne skrytého podadresáre se soubory (WebP/AVIF) variací.');
...
@define('DELETE_HOTLINK_FILE', 'Vymazán odkazovanı soubor %s');
...
@define('NOT_WRITABLE_SPARTACUS', 'Vyadováno pro monost vzdáleného stahování zásuvnıch modulu, která je ve vıchozím nastavení aktivní prostrednictvím zásuvného modulu Spartacus!');
