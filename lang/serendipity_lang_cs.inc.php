...
@define('DELETE_DIRECTORY_DESC', 'Chystáte se odstranit adresár<sup>(¹)</sup>, kterı mue obsahovat mediální soubory a poloky ji pouité v polokách. Ujistete se!<sup>[¹]</sup> Vcetne skrytého podadresáre se soubory (WebP/AVIF) variací.');
