...
@define('RESIZE_BLAHBLAH', 'Redimensionează %s');
@define('ORIGINAL_SIZE', 'Mărime originală: <i>%sx%s</i> pixel');
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Aici puteți regla dimensiunea imaginii. Dacă doriți să redimensionați imaginea proporțional, introduceți o valoare în una dintre cele două casete și apăsați tasta TAB sau mouse-ul - se va calcula automat noua dimensiune, astfel încât proporțiile imaginii să nu fie afectate. <p><b>ATENȚIE:</b> Acesta nu este un instrument de redimensionare a imaginilor de înaltă calitate, optimizat pentru nevoile unei imagini specifice.<br>Fiecare redimensionare duce la o pierdere mai mare sau mai mică a calității imaginii în comparație cu fișierul original. Și această pierdere crește cu fiecare redimensionare ulterioară!</p>');
...
@define('CANT_EXECUTE_BINARY', 'Nu se poate executa calea binară %s (nu este obligatoriu atunci când se utilizează modulul de extensie)');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Ai ignorat paşii de actualizare pentru Serendipity, verifică te rog dacă baza de date e corect instalată, şi eventualele operaţiile programate sunt rulate. După ce ați terminat munca motivată pentru hold-back, acest lucru se poate face automat prin resetarea versiunii în fișierul serendipity_config_local.inc și rularea din nou a acestei pagini de actualizare prin intermediul paginii dvs. de backend.');
...
@define('DELETE_DIRECTORY_DESC', 'Sunteți pe cale să ștergeți un director<sup>(¹)</sup> care poate conține fișiere media și elemente deja utilizate în înregistrările dumneavoastră. Asigurați-vă!<br><sup>[¹]</sup> Inclusiv subdirectorul ascuns cu fișiere de variație (WebP/AVIF).');
...
@define('COMMENT_NOT_ADDED', 'Comentariul dvs. nu a putut fi adăugat, deoarece comentariile pentru această intrare au fost dezactivate, ați introdus date invalide sau comentariul dvs. a fost prins de măsurile anti-spam.');
