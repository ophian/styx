...
@define('THUMB_CREATED_DONE', 'Náhled %s je vytvoøen.<br>Hotovo.'); // ADD: and of all variations
...
@define('COMMENT_ADDED', 'Vá¹ komentáø %sbyl úspì¹nì pøidán.');
...
@define('SYNC_OPTION_DELETETHUMBS', 'Znovu vytvoøit (<em>*.%s</em>) v¹echny náhledy');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vynechal jste stupeò upgrade Serendipity, ujistìte se, ¾e databáze je správnì nainstalována a plánované funkce jsou spu¹tìny. Poté, co jste dokoncili zduvodnenou práci pro zadržení, lze toto provést automaticky pouhým resetováním verze v souboru serendipity_config_local.inc a opetovným spuštením této aktualizacní stránky prostrednictvím vaší backendové stránky.');
...
@define('INSTALL_IMAGEDIM', 'Omezující rozmìr pro náhledy');
@define('INSTALL_IMAGEDIM_LARGEST', 'Del¹í hrana');
@define('INSTALL_IMAGEDIM_WIDTH', '©íøka');
...
@define('POWERED_BY_SHOW_TEXT_DESC', 'Vytvoøeno v "Serendipity Styx" se zobrazí jako text');
...
@define('ADD_MEDIA_BLAHBLAH', '<b>Pøidat soubor do schránky médií:</b><p>Zde mù¾ete ukládat mediální soubory, nebo urèit, kde je získat z WEBu! Pokud nemáte odpovídající obrázek, <a href="https://images.google.com" rel="noopener" target="_blank">hledejte na Google</a> odpovìï na va¹i potøebu, obvykle se zadaøí :).<p><b>Vyberte metodu:</b><br>');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx byl úspì¹nì nainstalován');
...
@define('USERCONF_USERLEVEL_DESC', 'Tato úroveò urèuje práva u¾ivatele weblogu. Oprávnení uživatelu se rídí clenstvím ve skupinách!');
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Zde mù¾ete definovat svùj øetìzec, který bude zobrazen v konfiguraèní obrazovce pluginu spoleènì s popisem pluginu. Kdy¾ máte nìkolik stacked plugins / HTML nuggetù s prázdným tittle, toto vám pomù¾e je rozli¹it.');
...
@define('PERMISSION_ADMINIMAGESADD', 'adminImagesAdd: Pøidávání nových souborù medií');
...
@define('STYLE_OPTIONS_NONE', 'Toto téma/styl nemá specifické volby. Pokud chcete vìdìt, jak mù¾ete pro svoje ¹ablony nastavit specifické volby, ètìte Technical Documentation na "https://ophian.github.io/hc/en/templating.html#docs-theme-options"  "Configuration of Theme options".');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Je-li povoleno, mù¾e serendipity_admin_image_selector.php file vracet obrázky v jakékoli po¾adované velikosti pøes promìnnou  GET. Výsledky jsou ke¹ovány, a tak se mù¾e vytvoøit velký soubor, jestli¾e to intenzivnì pou¾íváte.');
...
@define('NAVLINK_AMOUNT', 'Zadejte poèet odkazù navigaèní li¹ty (and save this form)');
