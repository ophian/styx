...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Tu môžete nastaviť veľkosť obrázku. Ak chcete zmeniť veľkosť obrázku proporcionálne, stačí zadať hodnotu do jedného z dvoch polí a stlačiť klávesu TAB alebo myš – automaticky sa vypočíta nová veľkosť, aby sa neporušili proporcie obrázku. <p><b>POZNÁMKA:</b> Toto nie je špičkový nástroj na zmenu veľkosti obrázkov, prispôsobený potrebám konkrétneho obrázku.<br>Každé zmenšenie veľkosti má za následok viac či menej zvýšenú stratu kvality obrázku v porovnaní s pôvodným vstupným súborom. A táto strata sa zvyšuje s každým ďalším zmenšením!</p>');
...
@define('COMMENT_ADDED', 'Váš komentár %sbol úspešne pridaný.');
...
@define('PGSQL_REQUIRED', 'Na tento úkon musí byť nainštalované rozširenie PostgreSQL.');
@define('COULDNT_CONNECT', 'Nepodarilo sa spojiť s databázou MySQL: %s.');
@define('PGSQL_COULDNT_CONNECT', 'Nepodarilo sa spojiť s databázou PostgreSQL: %s.');
...
@define('DO_MARKUP_DESCRIPTION', 'Aplikujte (zásuvné moduly) transformácie značiek na text (smajlíky, bbcode, značky skratiek s9y, markdown atď.). Ak je vypnuté, obsah sa vykreslí 1:1 a zachová sa akékoľvek formátovanie HTML. Ak je táto možnosť aktivovaná, ostatné zásuvné moduly môžu obsah nugetu upravovať.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vynechali ste aktualizačný proces Serendipity, prosím preverte, či je Vaša databáza správne nainštalovaná a plánované úlohy boli spustené. Po skončení odôvodnenej práce na zadržaní sa to môže vykonať automaticky tak, že jednoducho vynulujete verziu v súbore serendipity_config_local.inc a spustíte túto stránku aktualizácie znova cez vašu backendovú stránku.');
...
@define('INSTALL_DBPASS_DESC', 'Heslo používateľa na pripojenie do databáyz. Ak je už nastavená, existuje len v prístupovom súbore "serendipity_config_local.inc", alebo ju možno nastaviť tu.');
@define('INSTALL_DBNAME', 'Názov');
@define('INSTALL_DBNAME_DESC', 'Názov databázy');
@define('INSTALL_DBPREFIX', 'Predpona');
@define('INSTALL_DBPREFIX_DESC', 'Predpona pre názvy tabuliek, napr. styx_');
...
@define('POWERED_BY_SHOW_TEXT', 'Zobraziť "%s" ako text');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Vytvorené v "Serendipity Styx" sa zobrazí ako text');
@define('POWERED_BY_SHOW_IMAGE', 'Zobraziť "%s" s logom');
...
@define('DELETE_DIRECTORY_DESC', 'Chystáte sa odstránit adresár<sup>(¹)</sup>, ktorý môže obsahovat mediálne súbory a položky už použité vo vašich záznamoch. Uistite sa!<br><sup>[¹]</sup> Vrátane skrytého podadresára so súbormi variácií (WebP/AVIF).');
@define('FORCE_DELETE', 'Odstránenie VŠETKÝCH súborov v tomto adresári vrátane podadresárov a súborov, ktoré knižnica MediaLibrary (zatiaľ) nepozná');
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Tu môžete zadať reťazec, ktorý bude zobrazený v konfiguračnej stránke doplnkov spolu s popisom doplnku. Ak máte niekoľko stacked plugins / HTML Nuggetov s prázdnym názvom, toto Vám pomôže ich rozlíšiť.');
...
@define('NOT_WRITABLE_SPARTACUS', 'Vyžaduje sa pre možnosť vzdialeného sťahovania zásuvných modulov, ktorá je predvolene aktívna prostredníctvom zásuvného modulu Spartakus!');
