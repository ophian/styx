...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vynechali ste aktualizaèný proces Serendipity, prosím preverte, èi je Va¹a databáza správne nain¹talovaná a plánované úlohy boli spustené. After having finished your reasoned work for hold-back, this can be done automatically by just resetting the version in your serendipity_config_local.inc (only) file and run this upgrade page again via your backend page.');
