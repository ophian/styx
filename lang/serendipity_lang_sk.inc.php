...
@define('IMAGESYNC_WARNING', 'POZOR:<br>Tento úkon mô¾e trva» dlh¹ie, ak máte veµa obrázkov bez náhµadov. Particularly with migrations of old blogs, further preliminary considerations and knowledge are necessary! Read about it on <a href="https://ophian.github.io/hc/en/media-migration-tasks.html" target="_new">this help page</a>, carefully.');
...
@define('THUMB_CREATED_DONE', 'Náhµad %s vytvorený.<br>Hotové.'); // ADD: and of all variations
...
@define('SUBSCRIBE_TO_BLOG', 'Odobera» tento weblog');
...
@define('COMMENT_ADDED', 'Vá¹ komentár %sbol úspe¹ne pridaný.');
...
@define('PGSQL_REQUIRED',  'Na tento úkon musí by» nain¹talované roz¹irenie PostgreSQL.');
@define('COULDNT_CONNECT', 'Nepodarilo sa spoji» s databázou MySQL: %s.');
@define('PGSQL_COULDNT_CONNECT', 'Nepodarilo sa spoji» s databázou PostgreSQL: %s.');
...
@define('FILE_NOT_FOUND', 'Nepodarilo sa nájs» súbor s názvom %s, mo¾no u¾ bol vymazaný?');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vynechali ste aktualizaèný proces Serendipity, prosím preverte, èi je Va¹a databáza správne nain¹talovaná a plánované úlohy boli spustené. Po skoncení odôvodnenej práce na zadržaní sa to môže vykonat automaticky tak, že jednoducho vynulujete verziu v súbore serendipity_config_local.inc a spustíte túto stránku aktualizácie znova cez vašu backendovú stránku.');
...
@define('DELETE_THUMBNAIL', 'Zmazaný náhµad obrázku s názvom %s');
@define('DELETE_FILE', 'Vymaza» súbor s názvom %s');
@define('ABOUT_TO_DELETE_FILE', 'Chcete zmaza» <b>%s</b><br>Ak pou¾ívate tento súbor v èlánkoch, spôsobí to neprítomnos» odkazov alebo obrázkov.<br>Napriek tomu pokraèova»?');
...
@define('INSTALL_DBPERSISTENT_DESC', 'Zapnú» trvalé pripojenie do databázy, viac informácií nájdete <a href="https://php.net/manual/features.persistent-connections.php" rel="noopener" target="_blank">tu</a>. Nastavenie neodporúèame.');
...
@define('WELCOME_TO_INSTALLATION', 'Vitajte v in¹talácii Serendipity Styx');
...
@define('PRE_INSTALLATION_REPORT', 'Serendipity Styx v.%s - predin¹talaèná správa');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx bolo úspe¹ne nain¹talované');
@define('VISIT_BLOG_HERE', 'Tu nav¹tívite svoj nový weblog');
@define('THANK_YOU_FOR_CHOOSING', 'Ïakujeme, ¾e ste si vybrali Serendipity Styx');
...
@define('CONVERT_HTMLENTITIES', 'Skúsi» automatickú konverziu HTML entít?'); // Translate again
...
@define('STYLE_OPTIONS_NONE', 'Táto téma/¹týl nemá ¹pecifické voµby. Ak chcete vedie», ako mô¾ete pre Va¹e ¹ablóny nastavi» ¹pecifické voµby, preèítajte si Technical Documentation (technickú dokumentáciu) na "https://ophian.github.io/hc/en/templating.html#docs-theme-options" "Configuration of Theme options".');
...
@define('MEDIA_DYN_RESIZE_DESC', 'Ak je zapnuté, mô¾e serendipity_admin_image_selector.php file vraca» obrázky v akejkoµvek po¾adovanej veµkosti pomocou premennej GET. Výsledky sú cachované, tak¾e sa mô¾e pri intenzívnom vyu¾ití vytvori» veµké mno¾stvo súborov.');
