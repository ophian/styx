...
@define('ERROR_XSRF', 'Vafrinn þinn sendi ekki gildan HTTP-tilvísunarstreng. Í alvarlegum tilfellum fyrir tilvísarann gæti þetta annað hvort hafa stafað af rangstilltum vafra/proxy eða af Cross Site Request Forgery (XSRF) sem beint var að þér. Annars geta þessi skilaboð aðeins gefið til kynna að flipinn þinn hafi verið opinn of lengi og núverandi breytingartákn þitt sé útrunnið. Ekki var hægt að ljúka aðgerðinni sem þú baðst um.');
