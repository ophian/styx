...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Hér geturðu stillt stærð myndarinnar. Ef þú vilt breyta stærð myndarinnar hlutfallslega, sláðu einfaldlega inn gildi í annað hvort reitinn og ýttu á TAB eða músarhnappinn -- það mun sjálfkrafa reikna út nýju stærðina svo hlutföll myndarinnar raskist ekki. <b>VINSAMLEGAST Takið eftir:</b> Þetta er ekki háþróað myndvinnslutæki sem fínstillt er fyrir þarfir einstakrar myndar. Hver stækkun veldur meiri eða minni tapi í myndgæðum miðað við upphaflegu myndina. Og þetta eykst við hverja frekari stækkun!');
...
@define('CANT_EXECUTE_BINARY', 'Ekki hægt að framkvæma %s braut bin-skrárinnar (ekki nauðsynlegt þegar notað er viðbótarmódúlinn)');
...
@define('DO_MARKUP_DESCRIPTION', 'Notaðu (viðbót) merkingarbreytingar á textann (broskallar, bbcode, s9y flýtileiðir, markdown, osfrv.). Ef slökkt er á því er efnið gefið 1:1 og hvaða HTML-snið sem er varðveitt. Ef þessi valkostur er virkur geta önnur viðbætur breytt innihaldi gullmolans.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Þú hefur hundsað uppfærslustig Serendipity. Vinsamlegast gakktu úr skugga um að gagnagrunnurinn sé rétt uppsettur, og fyrirætluð virkni sé í gangi. Eftir að hafa lokið rökstuddu verki þínu til að halda aftur, er hægt að gera þetta sjálfkrafa með því að endurstilla útgáfuna í serendipity_config_local.inc skránni þinni og keyra þessa uppfærslusíðu aftur í gegnum bakendasíðuna þína.');
...
@define('HOTLINK_DONE', 'Skrá "%s" hotlinkuð.<br>Internal name: \'%s\'. Búin.');
...
@define('ERROR_XSRF', 'Vafrinn þinn sendi ekki gildan HTTP-tilvísunarstreng. Fyrir tilvísandann gæti þetta annað hvort hafa stafað af rangt stilltum vafra/proxy eða af Cross Site Request Forgery (XSRF) sem beint var að þér. Annars geta þessi skilaboð aðeins gefið til kynna að flipinn þinn hafi verið opinn of lengi og núverandi breytingartákn þitt sé útrunnið. Ekki var hægt að ljúka aðgerðinni sem þú baðst um.');
