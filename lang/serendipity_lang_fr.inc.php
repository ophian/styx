...
@define('WYSIWYG_LANG', 'fr_FR');
@define('TINYMCE_LANG', 'fr');
@define('NUMBER_FORMAT_DECIMALS', '2');
@define('NUMBER_FORMAT_DECPOINT', '.');
@define('NUMBER_FORMAT_THOUSANDS', ',');
@define('LANG_DIRECTION', 'ltr');

@define('SERENDIPITY_ADMIN_SUITE', 'Administration de Serendipity Styx');
...
@define('IMAGESYNC_WARNING', 'ATTENTION:<br>Ceci peut prendre du temps s\'il y beaucoup d\'images sans miniatures. Particularly with migrations of old blogs, further preliminary considerations and knowledge are necessary! Read about it on <a href="https://ophian.github.io/hc/en/media-migration-tasks.html" target="_new">this help page</a>, carefully.');
...
@define('RESIZE_BLAHBLAH', 'Redimensionner %s');
@define('ORIGINAL_SIZE', 'Taille d\'origine : <i>%sx%s</i> pixel');
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Ici, vous pouvez ajuster la taille de l\'image. Si vous souhaitez redimensionner l\'image proportionnellement, il vous suffit d\'entrer une valeur dans l\'une des deux cases et d\'appuyer sur la touche TAB ou sur le bouton de la souris. La nouvelle taille sera automatiquement calculée afin que les proportions de l\'image ne soient pas altérées. <p><b>REMARQUE :</b> il ne s\'agit pas d\'un outil de redimensionnement d\'image haut de gamme, optimisé pour les besoins d\'une image spécifique. <br>Chaque redimensionnement entraîne une perte plus ou moins importante de la qualité de l\'image par rapport au fichier d\'origine. Et cette perte augmente à chaque nouveau redimensionnement !</p>');
...
@define('COMMENT_ADDED', 'Votre commentaire %sa été ajouté.');
...
@define('CANT_EXECUTE_BINARY', 'Impossible d\'exécuter le chemin binaire %s (non obligatoire lors de l\'utilisation du module d\'extension)');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Vous avez ignoré la mise à jour de Serendipity, assurez-vous que la base de données est installée correctement, et que les tâches nécessaires sont effectuées. Après avoir terminé votre travail raisonné pour la retenue, cela peut être fait automatiquement en réinitialisant la version dans votre fichier serendipity_config_local.inc et en exécutant à nouveau cette page de mise à niveau via votre page de backend.');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Avez-vous installé la bibliothèque binaire ImageMagick ou le module Imagick et souhaitez-vous l\'utiliser pour redimensionner des images ?');
...
@define('POWERED_BY_SHOW_TEXT', 'Afficher \'%s\' en tant que texte');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Affiche le slogan \'Serendipity Styx Weblog\' en tant que texte');
@define('POWERED_BY_SHOW_IMAGE', 'Afficher \'%s\' avec un logo');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Affiche le logo %s');
...
@define('WELCOME_TO_ADMIN', 'Bienvenue dans l\'interface d\'administration de Serendipity Styx.');
...
@define('WELCOME_TO_INSTALLATION', 'Bienvenue dans l\'assistant d\'installation de Serendipity Styx');
...
@define('SERENDIPITY_INSTALLED', 'Serendipity Styx a été installé avec succès');
@define('VISIT_BLOG_HERE', 'Accéder à votre nouveau blog');
@define('THANK_YOU_FOR_CHOOSING', 'Merci d\'avoir choisi Serendipity Styx');
...
@define('USERCONF_USERLEVEL_DESC', 'Ce niveau est utilisé pour déterminer quel type d\'accès cet utilisateur aura sur le blog. Les privilèges des utilisateurs sont gérés par l\'appartenance à un groupe !');
...
@define('ERROR_XSRF', 'Votre navigateur n\'a pas envoyé une chaîne HTTP-Referrer valide. Pour le référent, il peut s\'agir d\'un navigateur/proxy mal configuré ou d\'un Cross Site Request Forgery (XSRF) dont vous êtes la cible. Sinon, ce message peut simplement indiquer que votre onglet est resté ouvert trop longtemps et que votre jeton d\'édition actuel a expiré. L\'action que vous avez demandée n\'a pas pu être réalisée.');
