...
@define('BACKEND_TITLE_FOR_NUGGET', 'Ici vous pouvez définir une chaine personnalisée qui sera affichée dans le plugin de l\'écran de configuration avec la description HTML du plugin. Si vous avez plusieurs stacked plugins / nuggets HTML sans titre cela vous permettra de les distinguer les uns des autres.');
