...
@define('ERROR_XSRF', 'Votre navigateur n\'a pas envoyé une chaîne HTTP-Referrer valide. Dans le cas d\'une situation grave pour le référent, cela peut être dû à une mauvaise configuration du navigateur/proxy ou à un Cross Site Request Forgery (XSRF) qui vous vise. Sinon, ce message peut simplement indiquer que votre onglet est resté ouvert trop longtemps et que votre jeton d\'édition actuel a expiré. L\'action que vous avez demandée n\'a pas pu être réalisée.');
