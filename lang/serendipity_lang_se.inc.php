...
@define('HERE_YOU_CAN_ENTER_BLAHBLAH', 'Här kan du justera bildstorleken. Om du vill ändra storleken på bilden proportionellt, ange bara ett värde i en av de två rutorna och tryck på TAB- eller musknappen – den nya storleken beräknas automatiskt så att bildens proportioner inte förstörs. <p><b>OBSERVERA:</b> Detta är inte ett avancerat bildredigeringsverktyg för storleksändring, finjusterat för behoven hos en specifik bild.<br>Varje skalning medför en mer eller mindre ökad förlust av bildkvalitet jämfört med den ursprungliga inmatningsfilen. Och detta ökar med varje ytterligare skalning!</p>');
...
@define('COMMENT_ADDED', 'Din kommentar %sär tillagd.');
...
@define('CANT_EXECUTE_BINARY', 'Kan inte köra binärvägen %s (krävs inte vid användning av tilläggsmodulen)');
...
@define('SERENDIPITY_UPGRADER_WELCOME', 'Hej, och välkommen till Serendipity uppgraderings-agent.');
...
@define('SERENDIPITY_UPGRADER_YOU_HAVE_IGNORED', 'Du har struntat i uppgraderingsfasen av Serendipity, se till att databasen är korrekt installerad, och att schemalagda uppgifter körs. Efter att ha avslutat ditt motiverade arbete för hold-back, kan detta göras automatiskt genom att bara återställa versionen i din serendipity_config_local.inc-fil och köra denna uppgraderingssida igen via din backend-sida.');
...
@define('INSTALL_DBPASS_DESC', 'Lösenordet som hör till ovanstående användarnamn. Om den redan är inställd finns den bara i accessfilen "serendipity_config_local.inc" eller kan ställas in här.');
...
@define('INSTALL_DBPREFIX_DESC', 'Prefixet för tabellnamnen, till exempel styx_');
...
@define('INSTALL_WYSIWYG', 'Använd RichText (WYSIWYG)-redigerare');
@define('INSTALL_WYSIWYG_DESC', 'Denna editor kommer att användas i vanliga textarea-fält som inmatningsformulär, statiska sidor, kommentarer (som har en ytterligare global alternativinställning) och några andra plugin-platser; Den lagrar HTML-markup direkt.');
...
@define('INSTALL_IMAGEMAGICK_DESC', 'Har du ImageMagick-biblioteket eller Imagick-modulen installerat och vill använda det för att ändra storlek på bilder?');
...
@define('POWERED_BY_SHOW_TEXT', 'Visa "%s" som text');
@define('POWERED_BY_SHOW_TEXT_DESC', 'Kommer att visa "Serendipity Styx Weblog" som text');
@define('POWERED_BY_SHOW_IMAGE', 'Visa "%s" med en logga');
@define('POWERED_BY_SHOW_IMAGE_DESC', 'Visar %s-logga');
...
@define('DELETE_DIRECTORY_DESC', 'Du håller på att radera en katalog<sup>(¹)</sup> som kan innehålla mediefiler och objekt som redan använts i dina poster. Var säker!<br><sup>[¹]</sup> Inklusive den dolda underkatalogen med (WebP/AVIF) variationsfiler.');
...
@define('ERROR_XSRF', 'Din webbläsare skickade inte en giltig HTTP-Referrer-sträng. För referenten kan detta antingen ha orsakats av en felkonfigurerad webbläsare/proxy eller av en XSRF (Cross Site Request Forgery) riktad mot dig. Annars kan det här meddelandet bara indikera att din flik har varit öppen för länge och att din nuvarande redigeringstoken har löpt ut. Den åtgärd du begärde kunde inte slutföras.');
