...
CREATE INDEX pl_idx ON {PREFIX}permalinks (permalink(250));
...
CREATE INDEX pluginlist_f_idx ON {PREFIX}pluginlist(plugin_file(250));
CREATE INDEX pluginlist_cn_idx ON {PREFIX}pluginlist(class_name(250));
CREATE INDEX pluginlist_pt_idx ON {PREFIX}pluginlist(plugintype(250));
CREATE INDEX pluginlist_pl_idx ON {PREFIX}pluginlist(pluginlocation(250));
