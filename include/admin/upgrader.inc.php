...
$tasks = array(
            ...
            array(  'version'   => '2.4.0',
                    ...
                    'desc'      => 'As long as documentary .htaccess rewrite files were available via Spartacus, this upgrade task had to run on every system upgrade.<details id="details_htaccesstask240" class="plugin_data"><summary role="button" aria-expanded="false">open details</summary><div>The following files will be removed from your system if available.<pre>' . implode(', ', $dead_files_230hta) . '</pre></div></details>'),
