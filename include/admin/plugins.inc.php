...
if (isset($_GET['serendipity']['plugin_to_conf'])) {
    ...
    foreach($classes AS $class_data) {
        ...
        if (is_object($plugin)) {
            ...
            $_ptype = isset($foreignPlugins['pluginstack'][$class_data['name']]['plugintype']) ? $foreignPlugins['pluginstack'][$class_data['name']]['plugintype'] : $_type; // Gotcha! Now also matches core sidebar plugins!!
