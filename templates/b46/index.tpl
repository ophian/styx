...
{if NOT $is_single_entry AND NOT $is_preview AND in_array($view, ['start', 'entries', 'archives']) AND $template_option.featured != 0 AND ($template_option.card > 0 OR $template_option.hugo > 0)}
