...
<ul>
    ...
    <li>Then install the plugin "Properties/Templates of categories (serendipity_event_categorytemplates)" Event Plugin and configure it with the default properties ( <em>No, timestamp DESC, No, Empty </em>). This, as well as the following step, is optional.</li>
