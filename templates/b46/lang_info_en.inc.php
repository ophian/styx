...
$info['theme_info_summary'] = 'A "Bootstrap 4.5.3" based HTML5 Framework Template, based on fallback engine "Bootstrap4".';
...
Apart from direct or copy theme usage, this allows to be used as a good middle-layer-engine for possible simple GRAND-child themes by "Engine: b45, bootstrap4", just by adding some additional user styles and probably changing the index files structural grid.';
