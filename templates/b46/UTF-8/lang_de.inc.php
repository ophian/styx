...
<p>Et voilà ! Ihr prominenter "featured article" wird nun auf den herausgehobenen Artikel als ganzer Artikel verweisen. Ansonsten ist er nur über den Archives-/Kategorielink im Blog erreichbar. Wird dieser Artikel irgendwann für einen anderen/neuen als normaler Artikel zurückgestuft, so ändern Sie im Artikel selbst die Kategorie und nehmen die beiden Häcken in den Erweiterte Eigenschaften von Artikeln (wie oben beschrieben) wieder heraus. Sie sehen also mit dieser Theme Option eine andere Art des Umganges mit quasi "Dauerhaften Artikeln", die ansonsten natürlich zum Serendipity Standardrepertoire in den "Erweiterten Artikeleigenschaften" gehören.</p>
</details>');
