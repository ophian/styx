        ...
        <form id="serendipity_comment" action="{$commentform_action}#feedback" method="post">
            ...
            <input type="hidden" name="serendipity[commentform]" value="true">
             ...
             <div class="form-group">
                <label for="serendipity_commentform_name">{$CONST.NAME} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-asterisk" viewBox="0 0 16 16"><title id="title_required_name">{$CONST.PLUGIN_CONTACTFORM_REQUIRED_FIELD}</title><path d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z"/></svg></label>
                <input id="serendipity_commentform_name" class="form-control" type="text" name="serendipity[name]" value="{$commentform_name}" required>
            </div>

            <div class="form-group">
                <label for="serendipity_commentform_email">{$CONST.EMAIL} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-asterisk" viewBox="0 0 16 16"><title id="title_required_email">{$CONST.PLUGIN_CONTACTFORM_REQUIRED_FIELD}</title>><path d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z"/></svg></label>
            ...
            <div class="form-group">
                <label for="serendipity_commentform_comment">{$CONST.COMMENT} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-asterisk" viewBox="0 0 16 16"><title id="title_required_comment">{$CONST.PLUGIN_CONTACTFORM_REQUIRED_FIELD}</title><path d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z"/></svg></label>
