{* Sliver frontend plugin_staticpage_related_article.tpl file v. 1.06, 2017-04-13 *}
...
{else}
    ...
    <div class="clearfix content serendipity_preface staticpage_related_article_list">
        {sliver_show_tags tag=$staticpage_custom.relTags template="sliver_related_articles.tpl" limit=$staticpage_custom.relNumb noSticky="true"}
    </div>
