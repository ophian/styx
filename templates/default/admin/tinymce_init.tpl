...
<script>
    document.addEventListener("DOMContentLoaded", (event) => {
      styxPlugs = typeof(styxConcatenatedToolbarPlugins) !== 'undefined' ? styxConcatenatedToolbarPlugins : '';
      tinymce.init({
        selector: '#{$item}',
        ...
        // Styx helper fnc to break-out containers - see help plugin and language additions
