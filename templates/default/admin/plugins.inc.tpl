                ...
                <li class="clearfix{if isset($plug.single_upgrade) AND $plug.single_upgrade} single_alert{/if}">
                    <div class="equal_heights">
                        ...
                        {if !empty($plug.website)}
                            <li class="plugin_web"><a href="{$plug.website|escape}"><span title="{$plug.exdoc|default:''}" class="icon-globe" aria-hidden="true"></span> {$plug.exdoc|default:''} {$CONST.PLUGIN_DOCUMENTATION}</a></li>
                        {/if}
