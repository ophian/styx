    ...
    {if $media.file.is_image}
        ...
        {else}
            ...
            {if $media.supportsWebP AND NOT empty($media.file.full_thumb_webp)}
                <input id="picSubmit" class="input_button state_submit" type="submit" value="{$CONST.ADD_MEDIA_PICTELEMENT|default:'Use &lt;picture&gt; element'}" data-submit="enhanced" onclick="serendipity.rememberMediaOptions(); serendipity.mediaPictureSubmit(); {$media.file.origfinishJSFunction}">
            {/if}
