...
{if $media.file.is_image}
        ...
        <picture>
{if isset($media.file.thumbSizeAVIF) AND $media.file.thumbSizeAVIF > 252 AND ($media.file.thumbSizeWebp == 0 OR $media.file.thumbSizeAVIF <= $media.file.thumbSizeWebp)}
            <source type="image/avif" srcset="{$media.file.full_thumb_avif|default:''}">
{/if}
        ...
        <form id="imageForm" name="serendipity[selForm]" action="#" method="GET">
            ...
            <input name="avifThumbName" type="hidden" value="{if isset($media.file.thumbSizeAVIF) AND $media.file.thumbSizeAVIF > 252}{$media.file.full_thumb_avif|default:''}{/if}">
            ...
            <input name="avifFileName" type="hidden" value="{if isset($media.file.sizeAVIF) AND $media.file.sizeAVIF > 252}{$media.file.full_file_avif|default:''}{/if}">
            ...
            <input name="srcAvifBestFormatSize" type="hidden" value="{if isset($media.file.sizeAVIF) AND $media.file.sizeAVIF > 252 AND ($media.file.sizeWebp == 0 OR $media.file.sizeAVIF <= $media.file.sizeWebp)}true{else}false{/if}">
...
{* Currently all 'frontend_image_selector_xxx' hooks are just dummies (used in the past) for the imageselectorplus event plugin. *}
            ...
            <div id="image_comment" class="form_area">
                ...
                <textarea id="serendipity_imagecomment" name="serendipity[imagecomment]" rows="5">{if isset($media.file.props.base_property)}{$media.file.props.base_property.ALL.COMMENT1|default:''|escape}{/if}</textarea>
            ...
            <div id="image_alttext" class="form_field">
                ...
                <input id="serendipity_alt" name="serendipity[alt]" type="text" value="{if isset($media.file.props.base_property)}{$media.file.props.base_property.ALL.ALT|default:''|escape}{/if}">
            ...
            <div id="image_title" class="form_field">
                ...
                <input id="serendipity_title" name="serendipity[title]" type="text" value="{if isset($media.file.props.base_property)}{$media.file.props.base_property.ALL.TITLE|default:''|escape}{/if}">
                {serendipity_hookPlugin hookAll=true hook='frontend_image_selector_title' data=$media.file}
            </div>
{/if}{* NOT media.filename_only end *}
