...
{if $media.file.is_image}
        ...
        <picture>
{if isset($media.file.thumbSizeAVIF) AND $media.file.thumbSizeAVIF > 252 AND $media.file.thumbSizeAVIF != 34165 AND $media.file.thumbSizeAVIF != 3389 AND ($media.file.thumbSizeWebp == 0 OR $media.file.thumbSizeAVIF <= $media.file.thumbSizeWebp)}
