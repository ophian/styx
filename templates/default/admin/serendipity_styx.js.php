    ...
    serendipity.serendipity_imageGallerySelector_done = function(textarea, g) {
        ...
        if (g['files'][0]) {
            ...
            $.each(g['files'], function(k, v) {
                ...
                iAVFrmt = (v['sizeAVIF'] > 252 && v['sizeAVIF'] != 34165 && ( v['sizeWebp'] == 0 || (v['sizeAVIF'] <= v['sizeWebp']) ));
                thbAVFt = (v['thumbSizeAVIF'] > 252 && v['thumbSizeAVIF'] != 34165 && ( v['thumbSizeWebp'] == 0 || (v['thumbSizeAVIF'] <= v['thumbSizeWebp']) ));
                imgID   = v['id'];
...
$(function() {
    ...
    $('.toggle_comment_full').click(function(e) {
        ...
        if ($el.data('href') && $el.data('href').indexOf(',') > -1) {
            ...
            if (length in cArray) {
                cArray.pop(); // remove, to not have a last doubled element item later on
            }
        } else {
            if ($el.attr('href')) {
                var $toggled = $($el.attr('href'));
