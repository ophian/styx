...
(function(serendipity, $, undefined ) {
    ...
    serendipity.choose_media = function(id) {
        serendipity.openPopup('serendipity_admin.php?serendipity[adminModule]=media&serendipity[popupContent]=true&serendipity[showMediaToolbar]=false&serendipity[showUpload]=true&serendipity[htmltarget]=' + id + '&serendipity[filename_only]=true');
    }
    ...
    serendipity.serendipity_imageGallerySelector_done = function(textarea, g) {
        ...
        if (g['files'][0]) {
            ...
            $.each(g['files'], function(k, v) {
                ...
                iAVFrmt = (v['sizeAVIF'] > 252 && ( v['sizeWebp'] == 0 || (v['sizeAVIF'] <= v['sizeWebp']) || !v['full_thumb_webp'] ));
                thbAVFt = (v['thumbSizeAVIF'] > 252 && ( v['thumbSizeWebp'] == 0 || (v['thumbSizeAVIF'] <= v['thumbSizeWebp'] || !v['thumbSizeWebp']) ));
                imgID   = v['id'];
    ...
    serendipity.closeCommentPopup = function() {
        <?php if ($GLOBALS['serendipity']['use_backendpopups'] || isset($GLOBALS['serendipity']['force_backendpopups']['comments'])): ?>
            parent.self.close();
        <?php else: ?>
    ...
    serendipity.openPopup = function(url) {
        <?php if ($GLOBALS['serendipity']['use_backendpopups'] || isset($GLOBALS['serendipity']['force_backendpopups']['images']) || isset($GLOBALS['serendipity']['force_backendpopups']['comments'])): ?>
            window.open(url,
                        'ImageSel',
...
$(function() {
    ...
    $('.wrap_insmedia').click(function() {
        serendipity.openPopup('serendipity_admin.php?serendipity[adminModule]=media&serendipity[popupContent]=true&serendipity[showMediaToolbar]=false&serendipity[showUpload]=true&serendipity[textarea]=' + $(this).attr('data-tarea'));
    });

    $('.wrap_insgal').click(function() {
        serendipity.openPopup('serendipity_admin.php?serendipity[adminModule]=media&serendipity[popupContent]=true&serendipity[showMediaToolbar]=false&serendipity[showGallery]=true&serendipity[textarea]=' + $(this).attr('data-tarea'));
    });
    ...
    <?php if ($GLOBALS['serendipity']['use_backendpopups'] || isset($GLOBALS['serendipity']['force_backendpopups']['categories'])): ?>
        if ($('#serendipityEntry').length > 0) {
    ...
    // Show tag selector
    <?php if ($GLOBALS['serendipity']['use_backendpopups'] || isset($GLOBALS['serendipity']['force_backendpopups']['tags'])): ?>
        if ($('#serendipityEntry').length > 0) {
    ...
    // Media file actions
    <?php if ($GLOBALS['serendipity']['use_backendpopups'] || isset($GLOBALS['serendipity']['force_backendpopups']['images'])): ?>
