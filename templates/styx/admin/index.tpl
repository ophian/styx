<!DOCTYPE html>
<html{if $admin_vars.darkmode} data-color-mode="dark"{else} data-color-mode="light"{/if} data-light-theme="light" data-dark-theme="dark" class="no-js" dir="ltr" lang="{$lang}">
<head>
