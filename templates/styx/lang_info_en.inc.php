...
This Standard Backend-Theme relegates to the core Styx backend templates in the "default/admin" subdirectory.
...
$info['theme_info_backend'] = 'This Standard Backend-Theme relegates to the core Styx backend templates in the "default/default" subdirectory.
...
For the moment it solely includes an index template, and the installer.inc and upgrader.inc files, which all remove irrelevant informations and assets when not logged in, beside adding the "Dark Mode".
This Standard Backend has its own style declarations files which add various continuously evolving enhancements to the backend.
