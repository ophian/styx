...
{if $is_form}
    <input id="category_submit" class="button-primary" type="submit" name="serendipity[isMultiCat]" value="{if NOT empty($smarty.get.serendipity.category)}{$CONST.RESET_FILTERS}{else}{$CONST.GO}{/if}">
{/if}
{if $show_all}
