...
$info['theme_info_summary'] = 'Language dependent Right-To-Left written RTL-Theme [still needs some love!]';

$info['theme_info_desc'] = 'Simple example theme from 2006 in right-to-left oriented manner, depending on the old styled default (Serendipity 2.3) theme.';
