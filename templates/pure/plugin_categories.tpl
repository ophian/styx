...
{if $is_form}
    <div class="category_submit"><input id="category_submit" type="submit" name="serendipity[isMultiCat]" value="{if isset($smarty.get.serendipity.category)}{$CONST.RESET_FILTERS}{else}{$CONST.GO}{/if}"></div>
{/if}
{if $show_all}
