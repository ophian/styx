...
{/if}
                            ...
                            <form id="serendipity_comment" action="{$commentform_action}#c0" method="post">
                                ...
                                <div class="form_tarea">
                                    ...
                                    <textarea id="serendipity_commentform_comment" rows="10" name="serendipity[comment]"{if NOT empty($required_fields.comment)} data-tooltip="Give me some data, please"{/if}>{$commentform_data}</textarea>
                                </div>
