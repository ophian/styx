...
<article class="archive archive_summary">
    ...
    {foreach $entries AS $sentries}
        ...
        <dd class="col-5 text-center col-sm-3 col-md-5 col-lg-3 text-lg-start col-xl-2"><time datetime="{$entry.timestamp|serendipity_html5time}">{$entry.timestamp|formatTime:'%d. %m. %Y'}</time></dd>
        {/foreach}
    {/foreach}
