...
<?php if ($GLOBALS['tpl']['is_form']): ?>
    <div class="category_submit"><input type="submit" name="serendipity[isMultiCat]" value="<?php if (!empty($_GET['serendipity']['category'])): ?><?= RESET_FILTERS ?><?php else: ?><?= GO ?><?php endif; ?>"></div>
<?php endif; ?>
