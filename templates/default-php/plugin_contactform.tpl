<div id="plugin_contact" class="clearfix serendipity_staticpage">
            ...
            <div id="serendipity_comment" class="serendipityCommentForm">
              ...
              <form id="serendipity_comment" action="<?= $GLOBALS['tpl']['commentform_action'] ?>#feedback" method="post">
                ...
                <div class="input-text">
                  <label for="serendipity_commentform_name"><?= NAME ?><?php if ($GLOBALS['tpl']['required_fields.name']): ?> &lowast;<?php endif; ?></label>
                  <input type="text" size="30" value="<?= $GLOBALS['tpl']['commentform_name'] ?>" name="serendipity[name]" id="serendipity_commentform_name">
                </div>

                <div class="input-text">
                  <label for="serendipity_commentform_email"><?= EMAIL ?><?php if ($GLOBALS['tpl']['required_fields.email']): ?> &lowast;<?php endif; ?></label>
                  <input type="text" size="30" value="<?= $GLOBALS['tpl']['commentform_email'] ?>" name="serendipity[email]" id="serendipity_commentform_email">
                </div>

                <div class="input-text">
                  <label for="serendipity_commentform_url"><?= HOMEPAGE ?><?php if ($GLOBALS['tpl']['required_fields.url']): ?> &lowast;<?php endif; ?></label>
                  <input type="text" size="30" value="<?= $GLOBALS['tpl']['commentform_url'] ?>" name="serendipity[url]" id="serendipity_commentform_url">
                </div>

                <div class="input-textarea">
                  <label for="serendipity_commentform_comment"><?= $GLOBALS['tpl']['plugin_contactform_message'] ?><?php if ($GLOBALS['tpl']['required_fields.comment']): ?> &lowast;<?php endif; ?></label>
