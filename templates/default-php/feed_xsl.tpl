...
<?= $GLOBALS['tpl']['channel_display_dat'] ?>
    ...
    <link rel="stylesheet" href="<?= serendipity_getTemplateFile('atom.css'); ?>" type="text/css" />
    ...
    <generator uri="https://ophian.github.io/" version="<?= $GLOBALS['tpl']['serendipityVersion'] ?>">Serendipity Sty Edition  <?= $GLOBALS['tpl']['serendipityVersion'] ?> - https://ophian.github.io/</generator>
...
<?php foreach ($GLOBALS['tpl']['entries'] AS $entry): ?>
    <entry class="item">
        ...
        <author>
            ...
            <?php if ($entry['feed_email'] != 'nospam@example.com'): ?><email><?= $entry['feed_email'] ?></email><?php endif; ?>
        </author>
