...
<?php endif; ?>
<?php if (!$GLOBALS['tpl']['staticpage_jsStr'] OR empty($GLOBALS['tpl']['staticpage_jsStr'])): ?>
    ...
    <?php endif; ?>
    <?php if (is_array($GLOBALS['tpl']['staticpage_listContent']) AND !empty($GLOBALS['tpl']['staticpage_listContent'])): ?>
