...
<article id="staticpage_<?= serendipity_makeFilename($GLOBALS['tpl']['staticpage_pagetitle']); ?>" class="clearfix serendipity_staticpage<?php if ($GLOBALS['tpl']['staticpage_articleformat']): ?> serendipity_entry<?php endif; ?>">
    <header>
        <h2><?php if ($GLOBALS['tpl']['staticpage_articleformat']): ?><?php if ($GLOBALS['tpl']['staticpage_articleformattitle']): ?><?= $GLOBALS['tpl']['staticpage_articleformattitle'] ?><?php else: ?><?= htmlspecialchars($GLOBALS['tpl']['staticpage_pagetitle']) ?><?php endif; ?><?php else: ?><?php if ($GLOBALS['tpl']['staticpage_headline']): ?><?= $GLOBALS['tpl']['staticpage_headline'] ?><?php else: ?><?= htmlspecialchars($GLOBALS['tpl']['staticpage_pagetitle']) ?><?php endif; ?><?php endif; ?></h2>
    <?php if (is_array($GLOBALS['tpl']['staticpage_navigation']) && ($GLOBALS['tpl']['staticpage_shownavi'] || $GLOBALS['tpl']['staticpage_show_breadcrumb'])): ?>
        ...
        <?php if ($GLOBALS['tpl']['staticpage_shownavi']): ?>
            <ul class="staticpage_navigation">
                ...
                <li class="staticpage_navigation_center"><?php if ($GLOBALS['tpl']['staticpage_navigation']['top']['new']): ?><?php if (!empty($GLOBALS['tpl']['staticpage_navigation']['top']['topp_name'])): ?><a href="<?= $GLOBALS['tpl']['staticpage_navigation']['top']['topp_link'] ?>" title="top"><?= $GLOBALS['tpl']['staticpage_navigation']['top']['topp_name'] ?></a> | <?php endif; ?>&#171 <?= htmlspecialchars($GLOBALS['tpl']['staticpage_navigation']['top']['curr_name']) ?> &#187; <?php if (!empty($GLOBALS['tpl']['staticpage_navigation']['top']['exit_name'])): ?>| <a href="<?= $GLOBALS['tpl']['staticpage_navigation']['top']['exit_link'] ?>" title="exit"><?= htmlspecialchars($GLOBALS['tpl']['staticpage_navigation']['top']['exit_name']) ?></a><?php endif; ?><?php else: ?><a href="<?= $GLOBALS['tpl']['staticpage_navigation']['top']['link'] ?>" title="current page"><?= htmlspecialchars($GLOBALS['tpl']['staticpage_navigation']['top']['name']) ?></a><?php endif; ?></li>
...
<?php else: ?>
    ...
    <div class="clearfix content staticpage_childpages">
        <ul id="staticpage_childpages">
            ...
            <li><a href="<?= $childpage['permalink'] ?>" title="<?= htmlspecialchars($childpage['pagetitle']) ?>"><?= htmlspecialchars($childpage['pagetitle']) ?></a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <?php endif; ?>
