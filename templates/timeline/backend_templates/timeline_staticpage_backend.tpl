<!-- TIMELINE RESPONSIVE_TEMPLATE.TPL start -->
...
<div id="backend_sp_respond" class="default_staticpage">
    ...
    <div id="el3" class="config_optiongroup additional_info">
        ...
        <fieldset id="sp_option_data" class="clearfix sect_opt">
            ...
            <div id="entry_option_show_sidebars" class="form_field form_radio sp_sect">{* CUSTOM TO THIS TEMPLATE - OPTION TO SHOW/HIDE RIGHT SIDEBAR *}
                <label class="sp_label" title="{$CONST.STATIC_SHOW_SIDEBARS_TITLE}">{$CONST.STATIC_SHOW_SIDEBARS_TEXT}</label>
                <div class="sp_input_radio">
                    <input id="sidebars_yes" type="radio" name="serendipity[plugin][custom][show_sidebars]" {if isset($form_values.custom.show_sidebars) AND $form_values.custom.show_sidebars != 'false'}checked="checked" {/if}value="true">
                    <label for="sidebars_yes">{$CONST.YES}</label>
                    <input id="sidebars_no" type="radio" name="serendipity[plugin][custom][show_sidebars]" {if NOT isset($form_values.custom.show_sidebars) OR $form_values.custom.show_sidebars == 'false'}checked="checked" {/if}value="false">
...
<!-- TIMELINE RESPONSIVE_TEMPLATE.TPL end -->
