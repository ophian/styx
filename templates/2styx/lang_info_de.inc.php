...
Dieses Backend Beispiel-Theme verweist auf die Styx Kern Backend Templates im "2k11/admin" Unterverzeichnis.
Als Beispiel zeigt es die Möglichkeit, ein eigenes und mehr oder weniger leeres Backend Theme zu erstellen, dass als "Fallback" die Standard "2k11" Backend Template Dateien nutzt.
Mit dies im Hinterkopf, sind Sie in der Lage, nur diejenigen Dateien zu ändern und hinzuzufügen, die notwendig sind, um Ihre momentanen Bedürfnisse zu erfüllen.';

$info['theme_info_backend'] = 'Dieses Backend Beispiel-Theme verweist auf die Styx Kern Backend Templates im "2k11/admin" Unterverzeichnis.
Als Beispiel zeigt es die Möglichkeit, ein eigenes und mehr oder weniger leeres Backend Theme zu erstellen, dass als "Fallback" die Standard "2k11" Backend Template Dateien nutzt.
Mit dies im Hinterkopf, sind Sie in der Lage, nur diejenigen Dateien zu ändern und hinzuzufügen, die notwendig sind, um Ihre momentanen Bedürfnisse zu erfüllen.
...
* 2017-08-21 - Neu hinzugekommen ist ein Bugfix für die Backend-Ansichten mit "rtl" (right-to-left), auf rechts gedrehten Schrift Attributen im &lt;html&gt; Element.<br><br>

DAS FOLGENDE IST DIE BESCHREIBUNG DES FALLBACK BACKENDS&colon;<br>
Dieses Theme beherbergt die Styx-Kern Backend Templates im Unterverzeichnis "2k11/admin".
