<aside class="staticpage_results">
    ...
    {foreach $staticpage_results AS $result}
        <li><span class="block_level"><a href="{$result.permalink|escape}" title="{$result.pagetitle|escape}">{if !empty($result.headline)}{$result.headline}{else}{$result.pagetitle|escape}{/if}</a> ({$result.realname|escape})</span>
