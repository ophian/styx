            ...
            <div id="edit_entry_category" class="clearfix">
                <fieldset>
                    ...
                    <div id="category_filter" class="form_field{if $entry_vars.category_compact} compact{/if}">
                        ...
                        {if $use_backendpopups || $force_backendpopups.categories}<a href="#top" class="button_link button_up" title="{$CONST.UP}"><span class="ucc-up-pointing-triangle"></span></a>{/if}
