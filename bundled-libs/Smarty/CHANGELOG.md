...
## [4.5.7-Styx-dev-4] - 2026-08-26 (read Styx changes)
...
- PHP8.3 support [#925](https://github.com/smarty-php/smarty/issues/925)
  On Styx this is just a minor string match lookup.
...
## [4.3.2-dev-4] - 2023-03-30

### [Custom Styx features]
- Use of Null Coalescing Operator (??) where appropriate
- Remove sizeof as an alias of count in modifiers and functions
- Custom fixes for the esacpe/unescape:'htmlall' HTML-ENTITIES PHP 8.2 deprecation fixes
...
- Other custom Styx fixes (see 4.2.1-dev-13) are now already built-in or in case of error handlers or charsets were reconsidered to simplify future update merges 
